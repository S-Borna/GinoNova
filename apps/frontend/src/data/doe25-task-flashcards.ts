...
const TASK_16_FLASHCARDS: TaskFlashcard[] = [
    // Easy (10)
    { id: 't16-1', front: 'Vad är SSH?', back: 'Secure Shell\nKrypterad fjärranslutning.\nPort 22 default.', category: 'Grunder', difficulty: 'easy' },
    { id: 't16-2', front: 'Hur ansluter du till server?', back: 'ssh user@host\nssh user@192.168.1.10', category: 'Grundläggande', difficulty: 'easy' },
    { id: 't16-3', front: 'Var lagras SSH-nycklar?', back: '~/.ssh/\nid_rsa (privat)\nid_rsa.pub (publik)', category: 'Nycklar', difficulty: 'easy' },
    { id: 't16-4', front: 'Hur genererar du SSH-nyckelpar?', back: 'ssh-keygen\neller: ssh-keygen -t ed25519', category: 'Nycklar', difficulty: 'easy' },
    { id: 't16-5', front: 'Var läggs auktoriserade nycklar?', back: '~/.ssh/authorized_keys\nPå servern.', category: 'Nycklar', difficulty: 'easy' },
    { id: 't16-6', front: 'Hur kopierar du nyckel till server?', back: 'ssh-copy-id user@host\nLägger publik nyckel i authorized_keys.', category: 'Nycklar', difficulty: 'easy' },
    { id: 't16-7', front: 'Vilken fil konfigurerar SSH-server?', back: '/etc/ssh/sshd_config', category: 'Konfiguration', difficulty: 'easy' },
    { id: 't16-8', front: 'Vilken fil konfigurerar SSH-klient?', back: '~/.ssh/config\neller /etc/ssh/ssh_config', category: 'Konfiguration', difficulty: 'easy' },
    { id: 't16-9', front: 'Hur kopierar du fil med SSH?', back: 'scp fil user@host:/sökväg\nscp user@host:fil lokal', category: 'scp', difficulty: 'easy' },
    { id: 't16-10', front: 'Hur startar du om SSH-tjänsten?', back: 'sudo systemctl restart sshd\neller: service ssh restart', category: 'Tjänst', difficulty: 'easy' },
    // Medium (12)
    { id: 't16-11', front: 'Hur ansluter du på annan port?', back: 'ssh -p 2222 user@host', category: 'Portar', difficulty: 'medium' },
    { id: 't16-12', front: 'Hur skapar du SSH tunnel?', back: 'ssh -L local:host:remote user@server\nLocal port forwarding.', category: 'Tunnlar', difficulty: 'medium' },
    { id: 't16-13', front: 'Hur inaktiverar du lösenordsinloggning?', back: 'I sshd_config:\nPasswordAuthentication no', category: 'Säkerhet', difficulty: 'medium' },
...
const TASK_17_FLASHCARDS: TaskFlashcard[] = [
    // Easy (10)
    { id: 't17-1', front: 'Vad är UFW?', back: 'Uncomplicated Firewall\nEnkelt frontend för iptables.\nStandard i Ubuntu.', category: 'Grunder', difficulty: 'easy' },
    { id: 't17-2', front: 'Hur aktiverar du UFW?', back: 'sudo ufw enable', category: 'Grundläggande', difficulty: 'easy' },
    { id: 't17-3', front: 'Hur inaktiverar du UFW?', back: 'sudo ufw disable', category: 'Grundläggande', difficulty: 'easy' },
    { id: 't17-4', front: 'Hur visar du UFW-status?', back: 'sudo ufw status\nsudo ufw status verbose', category: 'Status', difficulty: 'easy' },
    { id: 't17-5', front: 'Hur tillåter du port 22 (SSH)?', back: 'sudo ufw allow 22\neller: sudo ufw allow ssh', category: 'Regler', difficulty: 'easy' },
    { id: 't17-6', front: 'Hur blockerar du en port?', back: 'sudo ufw deny 80', category: 'Regler', difficulty: 'easy' },
    { id: 't17-7', front: 'Hur tar du bort en regel?', back: 'sudo ufw delete allow 22\neller: sudo ufw delete 3 (radnummer)', category: 'Regler', difficulty: 'easy' },
    { id: 't17-8', front: 'Vad är default policy?', back: 'Vad som händer med trafik som inte matchar regler.\nDefault: deny incoming, allow outgoing', category: 'Policy', difficulty: 'easy' },
    { id: 't17-9', front: 'Hur sätter du default deny incoming?', back: 'sudo ufw default deny incoming', category: 'Policy', difficulty: 'easy' },
    { id: 't17-10', front: 'Hur tillåter du HTTP och HTTPS?', back: 'sudo ufw allow http\nsudo ufw allow https\neller: 80, 443', category: 'Regler', difficulty: 'easy' },
    // Medium (12)
    { id: 't17-11', front: 'Hur tillåter du specifik IP?', back: 'sudo ufw allow from 192.168.1.100', category: 'IP-regler', difficulty: 'medium' },
    { id: 't17-12', front: 'Hur tillåter du subnät?', back: 'sudo ufw allow from 192.168.1.0/24', category: 'IP-regler', difficulty: 'medium' },
    { id: 't17-13', front: 'Hur tillåter du IP till specifik port?', back: 'sudo ufw allow from 192.168.1.100 to any port 22', category: 'IP-regler', difficulty: 'medium' },
    { id: 't17-14', front: 'Hur anger du protokoll (TCP/UDP)?', back: 'sudo ufw allow 53/udp\nsudo ufw allow 80/tcp', category: 'Protokoll', difficulty: 'medium' },
    { id: 't17-15', front: 'Hur tillåter du portintervall?', back: 'sudo ufw allow 6000:6007/tcp', category: 'Regler', difficulty: 'medium' },
    { id: 't17-16', front: 'Hur visar du numrerade regler?', back: 'sudo ufw status numbered\nBra för att radera specifika regler.', category: 'Status', difficulty: 'medium' },
    { id: 't17-17', front: 'Hur infogar du regel på specifik position?', back: 'sudo ufw insert 1 deny from 1.2.3.4', category: 'Regler', difficulty: 'medium' },
    { id: 't17-18', front: 'Vad är UFW application profiles?', back: 'Fördefinierade regler för appar.\nsudo ufw app list\nsudo ufw allow "OpenSSH"', category: 'Profiler', difficulty: 'medium' },
    { id: 't17-19', front: 'Hur visar du info om app-profil?', back: 'sudo ufw app info "Nginx Full"', category: 'Profiler', difficulty: 'medium' },
    { id: 't17-20', front: 'Hur aktiverar du loggning?', back: 'sudo ufw logging on\nsudo ufw logging medium', category: 'Loggning', difficulty: 'medium' },
    { id: 't17-21', front: 'Var sparas UFW-loggar?', back: '/var/log/ufw.log', category: 'Loggning', difficulty: 'medium' },
    { id: 't17-22', front: 'Hur återställer du UFW till default?', back: 'sudo ufw reset\nTar bort alla regler.', category: 'Reset', difficulty: 'medium' },
    // Hard (8)
    { id: 't17-23', front: 'Hur tillåter du interface-specifik trafik?', back: 'sudo ufw allow in on eth0 to any port 80', category: 'Interface', difficulty: 'hard' },
    { id: 't17-24', front: 'Hur begränsar du anslutningar (rate limit)?', back: 'sudo ufw limit ssh\nBlockerar efter 6 anslutningar på 30 sek.', category: 'Säkerhet', difficulty: 'hard' },
    { id: 't17-25', front: 'Var finns UFW rules-filer?', back: '/etc/ufw/user.rules\n/etc/ufw/before.rules\n/etc/ufw/after.rules', category: 'Konfiguration', difficulty: 'hard' },
    { id: 't17-26', front: 'Hur lägger du till raw iptables-regel?', back: 'Redigera /etc/ufw/before.rules\neller after.rules', category: 'Avancerat', difficulty: 'hard' },
    { id: 't17-27', front: 'Hur aktiverar du IPv6 i UFW?', back: 'I /etc/default/ufw:\nIPV6=yes', category: 'IPv6', difficulty: 'hard' },
    { id: 't17-28', front: 'Hur blockerar du utgående trafik till IP?', back: 'sudo ufw deny out to 1.2.3.4', category: 'Utgående', difficulty: 'hard' },
    { id: 't17-29', front: 'Hur tillåter du routed/forward trafik?', back: 'I /etc/default/ufw:\nDEFAULT_FORWARD_POLICY="ACCEPT"', category: 'Routing', difficulty: 'hard' },
    { id: 't17-30', front: 'Hur debuggar du UFW-problem?', back: 'sudo ufw status verbose\ntail -f /var/log/ufw.log\niptables -L -n -v', category: 'Debug', difficulty: 'hard' }
]
...
const TASK_18_FLASHCARDS: TaskFlashcard[] = [
    // Easy (10)
    { id: 't18-1', front: 'Vad är firewalld?', back: 'Dynamisk firewall-daemon.\nStandard i RHEL/CentOS/Fedora.\nZon-baserad.', category: 'Grunder', difficulty: 'easy' },
    { id: 't18-2', front: 'Hur startar du firewalld?', back: 'sudo systemctl start firewalld\nsudo systemctl enable firewalld', category: 'Tjänst', difficulty: 'easy' },
    { id: 't18-3', front: 'Hur visar du firewalld-status?', back: 'sudo firewall-cmd --state\nsudo systemctl status firewalld', category: 'Status', difficulty: 'easy' },
    { id: 't18-4', front: 'Vad är en zon i firewalld?', back: 'Fördefinierad säkerhetsnivå.\nEx: public, home, trusted, drop.\nInterface kopplas till zon.', category: 'Zoner', difficulty: 'easy' },
    { id: 't18-5', front: 'Hur listar du alla zoner?', back: 'sudo firewall-cmd --get-zones', category: 'Zoner', difficulty: 'easy' },
    { id: 't18-6', front: 'Hur visar du aktiv zon?', back: 'sudo firewall-cmd --get-active-zones', category: 'Zoner', difficulty: 'easy' },
    { id: 't18-7', front: 'Hur listar du regler i default-zon?', back: 'sudo firewall-cmd --list-all', category: 'Regler', difficulty: 'easy' },
    { id: 't18-8', front: 'Hur tillåter du en tjänst?', back: 'sudo firewall-cmd --add-service=ssh', category: 'Tjänster', difficulty: 'easy' },
    { id: 't18-9', front: 'Hur tillåter du en port?', back: 'sudo firewall-cmd --add-port=80/tcp', category: 'Portar', difficulty: 'easy' },
    { id: 't18-10', front: 'Vad gör --permanent flaggan?', back: 'Sparar regel permanent.\nUtan: gäller bara till reload/reboot.', category: 'Permanent', difficulty: 'easy' },
    // Medium (12)
    { id: 't18-11', front: 'Hur gör du ändring permanent?', back: 'sudo firewall-cmd --permanent --add-service=http\nsudo firewall-cmd --reload', category: 'Permanent', difficulty: 'medium' },
    { id: 't18-12', front: 'Hur laddar du om firewalld?', back: 'sudo firewall-cmd --reload', category: 'Reload', difficulty: 'medium' },
    { id: 't18-13', front: 'Hur tar du bort tjänst?', back: 'sudo firewall-cmd --remove-service=http', category: 'Tjänster', difficulty: 'medium' },
    { id: 't18-14', front: 'Hur listar du tillgängliga tjänster?', back: 'sudo firewall-cmd --get-services', category: 'Tjänster', difficulty: 'medium' },
    { id: 't18-15', front: 'Hur visar du info om en tjänst?', back: 'sudo firewall-cmd --info-service=ssh', category: 'Tjänster', difficulty: 'medium' },
    { id: 't18-16', front: 'Hur anger du specifik zon?', back: 'sudo firewall-cmd --zone=public --add-service=http', category: 'Zoner', difficulty: 'medium' },
    { id: 't18-17', front: 'Hur ändrar du default-zon?', back: 'sudo firewall-cmd --set-default-zone=home', category: 'Zoner', difficulty: 'medium' },
    { id: 't18-18', front: 'Hur flyttar du interface till zon?', back: 'sudo firewall-cmd --zone=trusted --change-interface=eth1', category: 'Interface', difficulty: 'medium' },
    { id: 't18-19', front: 'Vad är rich rules?', back: 'Avancerade regler med fler villkor.\nKällor, destinationer, loggning etc.', category: 'Rich Rules', difficulty: 'medium' },
    { id: 't18-20', front: 'Hur blockerar du specifik IP?', back: 'sudo firewall-cmd --add-rich-rule=\'rule family="ipv4" source address="1.2.3.4" reject\'', category: 'Rich Rules', difficulty: 'medium' },
    { id: 't18-21', front: 'Vad är panic mode?', back: 'Blockerar ALL nätverkstrafik!\nfirewall-cmd --panic-on\nAnvänd för nödsituationer.', category: 'Säkerhet', difficulty: 'medium' },
    { id: 't18-22', front: 'Hur listar du permanenta vs aktiva regler?', back: '--list-all: aktiva\n--list-all --permanent: sparade', category: 'Regler', difficulty: 'medium' },
    // Hard (8)
    { id: 't18-23', front: 'Hur skapar du egen tjänst?', back: 'Skapa XML i /etc/firewalld/services/\nKopiera från /usr/lib/firewalld/services/', category: 'Tjänster', difficulty: 'hard' },
    { id: 't18-24', front: 'Hur skapar du egen zon?', back: 'sudo firewall-cmd --permanent --new-zone=custom\nsudo firewall-cmd --reload', category: 'Zoner', difficulty: 'hard' },
    { id: 't18-25', front: 'Hur aktiverar du port forwarding?', back: 'sudo firewall-cmd --add-forward-port=port=80:proto=tcp:toport=8080', category: 'Forwarding', difficulty: 'hard' },
    { id: 't18-26', front: 'Hur aktiverar du masquerading (NAT)?', back: 'sudo firewall-cmd --add-masquerade\nKrävs för port forwarding till annan host.', category: 'NAT', difficulty: 'hard' },
    { id: 't18-27', front: 'Var lagras firewalld-konfiguration?', back: '/etc/firewalld/\n/usr/lib/firewalld/ (default)', category: 'Konfiguration', difficulty: 'hard' },
    { id: 't18-28', front: 'Hur loggar du droppade paket?', back: 'sudo firewall-cmd --set-log-denied=all\nLoggar till systemd journal.', category: 'Loggning', difficulty: 'hard' },
    { id: 't18-29', front: 'Skillnad runtime vs permanent?', back: 'Runtime: aktiv nu, försvinner vid reload\nPermanent: sparad, kräver reload', category: 'Koncept', difficulty: 'hard' },
    { id: 't18-30', front: 'Hur synkar du runtime till permanent?', back: 'sudo firewall-cmd --runtime-to-permanent\nSparar alla aktiva ändringar.', category: 'Synk', difficulty: 'hard' }
]
...
const TASK_19_FLASHCARDS: TaskFlashcard[] = [
    // Easy (10)
    { id: 't19-1', front: 'Hur listar du blockenheter?', back: 'lsblk\nVisar diskar och partitioner.', category: 'Grunder', difficulty: 'easy' },
    { id: 't19-2', front: 'Hur visar du diskutrymme?', back: 'df -h\n-h = human readable (GB, MB)', category: 'Grunder', difficulty: 'easy' },
    { id: 't19-3', front: 'Hur visar du filstorlekar?', back: 'du -sh /path\n-s = summary, -h = human', category: 'Grunder', difficulty: 'easy' },
    { id: 't19-4', front: 'Var monteras diskar vanligtvis?', back: '/mnt eller /media\n/mnt: manuella mounts\n/media: automatiska', category: 'Mount', difficulty: 'easy' },
    { id: 't19-5', front: 'Hur monterar du en partition?', back: 'sudo mount /dev/sdb1 /mnt/disk', category: 'Mount', difficulty: 'easy' },
    { id: 't19-6', front: 'Hur avmonterar du?', back: 'sudo umount /mnt/disk\neller: sudo umount /dev/sdb1', category: 'Mount', difficulty: 'easy' },
    { id: 't19-7', front: 'Vad är /etc/fstab?', back: 'Fil som definierar automatiska mounts vid boot.', category: 'fstab', difficulty: 'easy' },
    { id: 't19-8', front: 'Hur partitionerar du disk?', back: 'fdisk /dev/sdb (MBR)\ngdisk /dev/sdb (GPT)\nparted', category: 'Partitioner', difficulty: 'easy' },
    { id: 't19-9', front: 'Hur formaterar du partition med ext4?', back: 'sudo mkfs.ext4 /dev/sdb1', category: 'Filsystem', difficulty: 'easy' },
    { id: 't19-10', front: 'Vad är LVM?', back: 'Logical Volume Manager\nFlexibel diskhantering.\nKan ändra storlek dynamiskt.', category: 'LVM', difficulty: 'easy' },
    // Medium (12)
    { id: 't19-11', front: 'Vilka är LVM:s tre lager?', back: 'PV: Physical Volume (disk)\nVG: Volume Group (pool)\nLV: Logical Volume (partition)', category: 'LVM', difficulty: 'medium' },
    { id: 't19-12', front: 'Hur skapar du Physical Volume?', back: 'sudo pvcreate /dev/sdb', category: 'LVM', difficulty: 'medium' },
    { id: 't19-13', front: 'Hur skapar du Volume Group?', back: 'sudo vgcreate myvg /dev/sdb /dev/sdc', category: 'LVM', difficulty: 'medium' },
    { id: 't19-14', front: 'Hur skapar du Logical Volume?', back: 'sudo lvcreate -L 10G -n mylv myvg', category: 'LVM', difficulty: 'medium' },
    { id: 't19-15', front: 'Hur listar du PV/VG/LV?', back: 'pvs, vgs, lvs\neller: pvdisplay, vgdisplay, lvdisplay', category: 'LVM', difficulty: 'medium' },
    { id: 't19-16', front: 'Hur utökar du LV?', back: 'sudo lvextend -L +5G /dev/myvg/mylv\nDärefter: resize2fs /dev/myvg/mylv', category: 'LVM', difficulty: 'medium' },
    { id: 't19-17', front: 'fstab-format?', back: 'device mountpoint fstype options dump pass\n/dev/sdb1 /mnt ext4 defaults 0 2', category: 'fstab', difficulty: 'medium' },
    { id: 't19-18', front: 'Vad är UUID?', back: 'Universally Unique Identifier\nUnikt för varje filsystem.\nblkid visar UUID.', category: 'UUID', difficulty: 'medium' },
    { id: 't19-19', front: 'Hur använder du UUID i fstab?', back: 'UUID=abc123... /mnt ext4 defaults 0 2\nSäkrare än /dev/sdX', category: 'fstab', difficulty: 'medium' },
    { id: 't19-20', front: 'Vad är swap?', back: 'Virtuellt minne på disk.\nAnvänds när RAM är fullt.\nmkswap, swapon', category: 'Swap', difficulty: 'medium' },
    { id: 't19-21', front: 'Hur skapar du swap-fil?', back: 'dd if=/dev/zero of=/swapfile bs=1G count=2\nmkswap /swapfile\nswapon /swapfile', category: 'Swap', difficulty: 'medium' },
    { id: 't19-22', front: 'Vad gör blkid?', back: 'Visar UUID, filsystemtyp och labels.\nblkid /dev/sdb1', category: 'Verktyg', difficulty: 'medium' },
    // Hard (8)
    { id: 't19-23', front: 'Skillnad MBR vs GPT?', back: 'MBR: max 4 primära, 2TB limit\nGPT: 128 partitioner, stöd för stora diskar', category: 'Partitioner', difficulty: 'hard' },
    { id: 't19-24', front: 'Hur krymper du LV?', back: 'OBS: Kan förlora data!\numount, resize2fs, lvreduce\nKrymper EJ om monterad.', category: 'LVM', difficulty: 'hard' },
    { id: 't19-25', front: 'Hur lägger du till disk till VG?', back: 'pvcreate /dev/sdd\nvgextend myvg /dev/sdd', category: 'LVM', difficulty: 'hard' },
    { id: 't19-26', front: 'Hur tar du snapshot med LVM?', back: 'lvcreate -L 1G -s -n snap /dev/myvg/mylv\n-s = snapshot', category: 'LVM', difficulty: 'hard' },
    { id: 't19-27', front: 'Vad är noatime mount-option?', back: 'Uppdaterar inte access time.\nFörbättrar prestanda på SSD.', category: 'Mount', difficulty: 'hard' },
    { id: 't19-28', front: 'Hur testar du fstab utan reboot?', back: 'mount -a\nMonterar allt i fstab som inte redan är monterat.', category: 'fstab', difficulty: 'hard' },
    { id: 't19-29', front: 'Hur reparerar du filsystem?', back: 'fsck /dev/sdb1\nMÅSTE vara avmonterat!\nfsck.ext4 för ext4', category: 'Reparation', difficulty: 'hard' },
    { id: 't19-30', front: 'Vad är LUKS?', back: 'Linux Unified Key Setup\nDisk-kryptering.\ncryptsetup luksFormat', category: 'Kryptering', difficulty: 'hard' }
]
...
const TASK_20_FLASHCARDS: TaskFlashcard[] = [
    ...
    { id: 't20-4', front: 'Hur komprimerar du med bzip2?', back: 'tar -cjvf arkiv.tar.bz2 filer/\n-j = bzip2', category: 'tar', difficulty: 'easy' },
    { id: 't20-5', front: 'Vad gör rsync?', back: 'Synkroniserar filer/kataloger.\nKopierar bara ändringar.\nEffektiv backup.', category: 'rsync', difficulty: 'easy' },
    { id: 't20-6', front: 'Grundläggande rsync-syntax?', back: 'rsync -av källa/ mål/\n-a = archive (bevarar allt)\n-v = verbose', category: 'rsync', difficulty: 'easy' },
    { id: 't20-7', front: 'Hur kopierar du med cp rekursivt?', back: 'cp -r källa/ mål/', category: 'cp', difficulty: 'easy' },
    { id: 't20-8', front: 'Vad är inkrementell backup?', back: 'Kopierar bara filer som\nändrats sedan förra backupen.', category: 'Koncept', difficulty: 'easy' },
    { id: 't20-9', front: 'Vad är full backup?', back: 'Kopierar ALLA filer.\nKrävs som bas för inkrementell.', category: 'Koncept', difficulty: 'easy' },
    { id: 't20-10', front: 'Hur listar du innehåll i tar?', back: 'tar -tvf arkiv.tar\n-t = list', category: 'tar', difficulty: 'easy' },
    // Medium (12)
    { id: 't20-11', front: 'rsync med progress?', back: 'rsync -av --progress källa/ mål/', category: 'rsync', difficulty: 'medium' },
    { id: 't20-12', front: 'rsync över SSH?', back: 'rsync -avz -e ssh källa/ user@host:/mål/', category: 'rsync', difficulty: 'medium' },
    { id: 't20-13', front: 'Vad gör rsync --delete?', back: 'Tar bort filer i mål som\ninte finns i källa.\nSynkroniserar exakt.', category: 'rsync', difficulty: 'medium' },
    { id: 't20-14', front: 'Vad gör rsync -n/--dry-run?', back: 'Visar vad som skulle hända\nutan att göra något.\nBra för test.', category: 'rsync', difficulty: 'medium' },
    { id: 't20-15', front: 'Hur exkluderar du filer i rsync?', back: 'rsync -av --exclude="*.log" källa/ mål/', category: 'rsync', difficulty: 'medium' },
    { id: 't20-16', front: 'Vad gör dd?', back: 'Disk duplicator.\nKopierar rå data bit-för-bit.\ndd if=/dev/sda of=/dev/sdb', category: 'dd', difficulty: 'medium' },
    { id: 't20-17', front: 'Hur skapar du disk image med dd?', back: 'dd if=/dev/sda of=disk.img bs=4M', category: 'dd', difficulty: 'medium' },
    { id: 't20-18', front: 'Vad är 3-2-1 backup-regeln?', back: '3 kopior av data\n2 olika medier\n1 offsite (annan plats)', category: 'Best Practice', difficulty: 'medium' },
    { id: 't20-19', front: 'Hur schemalägger du backup?', back: 'Använd cron.\ncrontab -e\n0 2 * * * /scripts/backup.sh', category: 'Schemaläggning', difficulty: 'medium' },
    { id: 't20-20', front: 'Hur packar du upp specifik fil från tar?', back: 'tar -xvf arkiv.tar fil.txt', category: 'tar', difficulty: 'medium' },
    { id: 't20-21', front: 'Hur komprimerar du med xz (bäst kompression)?', back: 'tar -cJvf arkiv.tar.xz filer/\n-J = xz (långsam men liten)', category: 'tar', difficulty: 'medium' },
    { id: 't20-22', front: 'Hur bevarar du rättigheter i tar?', back: 'tar -cvpf arkiv.tar filer/\n-p = preserve permissions', category: 'tar', difficulty: 'medium' },
    // Hard (8)
    { id: 't20-23', front: 'Hur gör du inkrementell backup med tar?', back: 'tar --listed-incremental=snapshot.snar -cvzf backup.tar.gz dir/', category: 'tar', difficulty: 'hard' },
    { id: 't20-24', front: 'Vad är rsnapshot?', back: 'Verktyg för rotationsbackuper.\nAnvänder hard links för utrymme.\nKonfigureras i /etc/rsnapshot.conf', category: 'Verktyg', difficulty: 'hard' },
    { id: 't20-25', front: 'Hur verifierar du backup?', back: 'Testa restore!\ntar -tvf för lista\nmd5sum för checksums', category: 'Verifiering', difficulty: 'hard' },
    { id: 't20-26', front: 'Vad är borgbackup?', back: 'Deduplicerande backup.\nKrypterad och komprimerad.\nEffektiv för stora dataset.', category: 'Verktyg', difficulty: 'hard' },
    { id: 't20-27', front: 'Hur klonar du partition med dd?', back: 'dd if=/dev/sda1 of=/dev/sdb1 bs=4M status=progress', category: 'dd', difficulty: 'hard' },
    { id: 't20-28', front: 'Vad gör rsync --link-dest?', back: 'Skapar hard links till oförändrade filer.\nEffektiv för inkrementella backuper.', category: 'rsync', difficulty: 'hard' },
    { id: 't20-29', front: 'Hur gör du remote backup med borgbackup?', back: 'borg create user@host:/repo::arkiv källa/', category: 'Verktyg', difficulty: 'hard' },
    { id: 't20-30', front: 'Hur automatiserar du backup med systemd timer?', back: 'Skapa .service och .timer\nsystemctl enable backup.timer', category: 'Schemaläggning', difficulty: 'hard' }
]
...
const TASK_21_FLASHCARDS: TaskFlashcard[] = [
    // Easy (10)
    { id: 't21-1', front: 'Vad är systemd?', back: 'Init-system och servicehanterare.\nPID 1, startar alla tjänster.', category: 'Grunder', difficulty: 'easy' },
    { id: 't21-2', front: 'Hur startar du en tjänst?', back: 'sudo systemctl start <tjänst>\nEx: systemctl start nginx', category: 'Tjänster', difficulty: 'easy' },
    { id: 't21-3', front: 'Hur stoppar du en tjänst?', back: 'sudo systemctl stop <tjänst>', category: 'Tjänster', difficulty: 'easy' },
    { id: 't21-4', front: 'Hur startar du om en tjänst?', back: 'sudo systemctl restart <tjänst>', category: 'Tjänster', difficulty: 'easy' },
    { id: 't21-5', front: 'Hur visar du tjänststatus?', back: 'systemctl status <tjänst>\nVisar state, PID, loggar.', category: 'Status', difficulty: 'easy' },
    { id: 't21-6', front: 'Hur aktiverar du tjänst vid boot?', back: 'sudo systemctl enable <tjänst>', category: 'Boot', difficulty: 'easy' },
    { id: 't21-7', front: 'Hur avaktiverar du tjänst vid boot?', back: 'sudo systemctl disable <tjänst>', category: 'Boot', difficulty: 'easy' },
    { id: 't21-8', front: 'Hur listar du alla tjänster?', back: 'systemctl list-units --type=service', category: 'Listing', difficulty: 'easy' },
    { id: 't21-9', front: 'Vad är en unit i systemd?', back: 'Resursobjekt: service, timer,\nmount, socket, target etc.', category: 'Koncept', difficulty: 'easy' },
    { id: 't21-10', front: 'Var finns systemd unit-filer?', back: '/etc/systemd/system/ (custom)\n/lib/systemd/system/ (default)', category: 'Filer', difficulty: 'easy' },
    // Medium (12)
    { id: 't21-11', front: 'Hur laddar du om konfiguration?', back: 'sudo systemctl daemon-reload\nKrävs efter ändring av unit-fil.', category: 'Reload', difficulty: 'medium' },
    { id: 't21-12', front: 'Hur laddar du om tjänst utan avbrott?', back: 'sudo systemctl reload <tjänst>\nFungerar om tjänsten stödjer det.', category: 'Reload', difficulty: 'medium' },
    { id: 't21-13', front: 'Vad gör enable --now?', back: 'sudo systemctl enable --now <tjänst>\nAktiverar OCH startar direkt.', category: 'Boot', difficulty: 'medium' },
    { id: 't21-14', front: 'Hur visar du dependencies?', back: 'systemctl list-dependencies <tjänst>', category: 'Dependencies', difficulty: 'medium' },
    { id: 't21-15', front: 'Hur visar du reverse dependencies?', back: 'systemctl list-dependencies --reverse <tjänst>', category: 'Dependencies', difficulty: 'medium' },
    { id: 't21-16', front: 'Hur visar du loggar för tjänst?', back: 'journalctl -u <tjänst>\n-f för live-följning', category: 'Logging', difficulty: 'medium' },
    { id: 't21-17', front: 'Hur visar du bootloggar?', back: 'journalctl -b\n-b -1 för förra booten', category: 'Logging', difficulty: 'medium' },
    { id: 't21-18', front: 'Grundläggande service unit-fil?', back: '[Unit]\nDescription=Min tjänst\n\n[Service]\nExecStart=/usr/bin/app\n\n[Install]\nWantedBy=multi-user.target', category: 'Unit-fil', difficulty: 'medium' },
    { id: 't21-19', front: 'Vad är targets i systemd?', back: 'Grupper av units.\nmulti-user.target ≈ runlevel 3\ngraphical.target ≈ runlevel 5', category: 'Targets', difficulty: 'medium' },
    { id: 't21-20', front: 'Hur ser du aktuellt target?', back: 'systemctl get-default', category: 'Targets', difficulty: 'medium' },
    { id: 't21-21', front: 'Hur visar du misslyckade tjänster?', back: 'systemctl --failed', category: 'Status', difficulty: 'medium' },
    { id: 't21-22', front: 'Vad är journald?', back: 'Systemd loggningsdaemon.\nLagrar binära loggar.\nAnvänd journalctl.', category: 'Logging', difficulty: 'medium' },
    // Hard (8)
    { id: 't21-23', front: 'Hur skapar du timer unit?', back: '[Unit]\nDescription=Timer\n\n[Timer]\nOnCalendar=daily\nPersistent=true\n\n[Install]\nWantedBy=timers.target', category: 'Timer', difficulty: 'hard' },
    { id: 't21-24', front: 'Hur maskerar du en tjänst?', back: 'sudo systemctl mask <tjänst>\nFörhindrar start helt.\nunmask för att återställa.', category: 'Säkerhet', difficulty: 'hard' },
    { id: 't21-25', front: 'Vad gör Restart=always?', back: 'I [Service]: Startar om tjänsten\nautomatiskt om den crashar.', category: 'Unit-fil', difficulty: 'hard' },
    { id: 't21-26', front: 'Hur begränsar du resurser för tjänst?', back: '[Service]\nMemoryLimit=512M\nCPUQuota=50%', category: 'Resurser', difficulty: 'hard' },
    { id: 't21-27', front: 'Vad är WantedBy vs RequiredBy?', back: 'WantedBy: svagt beroende (enable)\nRequiredBy: starkt beroende', category: 'Dependencies', difficulty: 'hard' },
    { id: 't21-28', front: 'Hur debuggar du startproblem?', back: 'systemctl status <tjänst>\njournalctl -xe\njournalctl -u <tjänst>', category: 'Debug', difficulty: 'hard' },
    { id: 't21-29', front: 'Hur sätter du environment i unit?', back: '[Service]\nEnvironment="VAR=value"\nEnvironmentFile=/etc/default/app', category: 'Config', difficulty: 'hard' },
    { id: 't21-30', front: 'Vad är socket activation?', back: 'Systemd lyssnar på socket.\nStartar tjänst vid anslutning.\nEffektivt för on-demand.', category: 'Avancerat', difficulty: 'hard' }
]
...
const TASK_24_FLASHCARDS: TaskFlashcard[] = [
    // Easy (10)
    { id: 't24-1', front: 'Vad är Docker Compose?', back: 'Verktyg för multi-container apps.\nDefinierar tjänster i YAML.\ndocker compose up', category: 'Grunder', difficulty: 'easy' },
    { id: 't24-2', front: 'Hur startar du compose?', back: 'docker compose up\n-d för detached (bakgrund)', category: 'Kommandon', difficulty: 'easy' },
    { id: 't24-3', front: 'Hur stoppar du compose?', back: 'docker compose down\nStoppar och tar bort containers.', category: 'Kommandon', difficulty: 'easy' },
    { id: 't24-4', front: 'Vad heter compose-filen?', back: 'docker-compose.yml\neller compose.yaml', category: 'Konfiguration', difficulty: 'easy' },
    { id: 't24-5', front: 'Grundläggande compose-struktur?', back: 'services:\n  web:\n    image: nginx\n    ports:\n      - "80:80"', category: 'YAML', difficulty: 'easy' },
    { id: 't24-6', front: 'Hur listar du compose-tjänster?', back: 'docker compose ps', category: 'Kommandon', difficulty: 'easy' },
    { id: 't24-7', front: 'Hur visar du loggar?', back: 'docker compose logs\n-f för follow', category: 'Logs', difficulty: 'easy' },
    { id: 't24-8', front: 'Hur startar du om tjänst?', back: 'docker compose restart <service>', category: 'Kommandon', difficulty: 'easy' },
    { id: 't24-9', front: 'Hur bygger du images med compose?', back: 'docker compose build\neller: docker compose up --build', category: 'Build', difficulty: 'easy' },
    { id: 't24-10', front: 'Hur kör du kommando i tjänst?', back: 'docker compose exec <service> bash', category: 'Kommandon', difficulty: 'easy' },
    // Medium (12)
    { id: 't24-11', front: 'Hur anger du build-context?', back: 'services:\n  app:\n    build: ./app\n    # eller:\n    build:\n      context: ./app\n      dockerfile: Dockerfile', category: 'Build', difficulty: 'medium' },
    { id: 't24-12', front: 'Hur definierar du volymer?', back: 'services:\n  db:\n    volumes:\n      - data:/var/lib/mysql\nvolumes:\n  data:', category: 'Volumes', difficulty: 'medium' },
    { id: 't24-13', front: 'Hur definierar du miljövariabler?', back: 'services:\n  app:\n    environment:\n      - NODE_ENV=prod\n    # eller:\n    env_file:\n      - .env', category: 'Config', difficulty: 'medium' },
    { id: 't24-14', front: 'Hur skapar du beroenden?', back: 'services:\n  app:\n    depends_on:\n      - db\n      - redis', category: 'Dependencies', difficulty: 'medium' },
    { id: 't24-15', front: 'Hur definierar du nätverk?', back: 'services:\n  app:\n    networks:\n      - frontend\n      - backend\nnetworks:\n  frontend:\n  backend:', category: 'Networking', difficulty: 'medium' },
    { id: 't24-16', front: 'Hur skalar du tjänst?', back: 'docker compose up -d --scale web=3', category: 'Scaling', difficulty: 'medium' },
    { id: 't24-17', front: 'Hur anger du restart policy?', back: 'services:\n  app:\n    restart: always\n    # no, on-failure, unless-stopped', category: 'Config', difficulty: 'medium' },
    { id: 't24-18', front: 'Vad gör docker compose pull?', back: 'Drar ner senaste versioner av alla images.', category: 'Kommandon', difficulty: 'medium' },
    { id: 't24-19', front: 'Hur kör du engångskommando?', back: 'docker compose run app npm test\nSkapar ny container för kommandot.', category: 'Kommandon', difficulty: 'medium' },
    { id: 't24-20', front: 'Hur stoppar du utan att ta bort?', back: 'docker compose stop\nBehåller containers och volymer.', category: 'Kommandon', difficulty: 'medium' },
    { id: 't24-21', front: 'Hur tar du bort volymer?', back: 'docker compose down -v\n-v tar bort volymer också.', category: 'Cleanup', difficulty: 'medium' },
    { id: 't24-22', front: 'Hur använder du .env-fil?', back: '.env i samma katalog.\nVARIABEL=värde\nAnvänds automatiskt.', category: 'Config', difficulty: 'medium' },
    // Hard (8)
    { id: 't24-23', front: 'Hur använder du profiles?', back: 'services:\n  debug:\n    profiles: [dev]\ndocker compose --profile dev up', category: 'Profiles', difficulty: 'hard' },
    { id: 't24-24', front: 'Hur gör du healthcheck i compose?', back: 'services:\n  app:\n    healthcheck:\n      test: curl -f http://localhost\n      interval: 30s', category: 'Health', difficulty: 'hard' },
    { id: 't24-25', front: 'Vad är depends_on condition?', back: 'depends_on:\n  db:\n    condition: service_healthy\nVäntar på healthcheck.', category: 'Dependencies', difficulty: 'hard' },
    { id: 't24-26', front: 'Hur begränsar du resurser?', back: 'services:\n  app:\n    deploy:\n      resources:\n        limits:\n          memory: 512M\n          cpus: "0.5"', category: 'Resurser', difficulty: 'hard' },
    { id: 't24-27', front: 'Hur använder du flera compose-filer?', back: 'docker compose -f base.yml -f prod.yml up\nFiler mergas i ordning.', category: 'Config', difficulty: 'hard' },
    { id: 't24-28', front: 'Vad är extends i compose?', back: 'services:\n  app:\n    extends:\n      file: common.yml\n      service: base\nÄrver från annan fil.', category: 'Avancerat', difficulty: 'hard' },
    { id: 't24-29', front: 'Hur loggar du till extern tjänst?', back: 'services:\n  app:\n    logging:\n      driver: json-file\n      options:\n        max-size: "10m"', category: 'Logging', difficulty: 'hard' },
    { id: 't24-30', front: 'Skillnad docker compose vs docker-compose?', back: 'docker compose: ny (v2, plugin)\ndocker-compose: gammal (v1, standalone)', category: 'Version', difficulty: 'hard' }
]
...
const TASK_25_FLASHCARDS: TaskFlashcard[] = [
    // Easy (10)
    { id: 't25-1', front: 'Vad är Git?', back: 'Distribuerat versionshanteringssystem.\nSpårar ändringar i kod.\nSkapar historik och branches.', category: 'Grunder', difficulty: 'easy' },
    { id: 't25-2', front: 'Hur initierar du repo?', back: 'git init\nSkapar .git-katalog.', category: 'Init', difficulty: 'easy' },
    { id: 't25-3', front: 'Hur klonar du repo?', back: 'git clone <url>\ngit clone git@github.com:user/repo.git', category: 'Clone', difficulty: 'easy' },
    { id: 't25-4', front: 'Hur visar du status?', back: 'git status\nVisar ändrade/staged filer.', category: 'Status', difficulty: 'easy' },
    { id: 't25-5', front: 'Hur lägger du till filer för commit?', back: 'git add <fil>\ngit add . (alla)\ngit add -A (allt)', category: 'Staging', difficulty: 'easy' },
    { id: 't25-6', front: 'Hur committar du?', back: 'git commit -m "meddelande"', category: 'Commit', difficulty: 'easy' },
    { id: 't25-7', front: 'Hur pushar du till remote?', back: 'git push\ngit push origin main', category: 'Push', difficulty: 'easy' },
    { id: 't25-8', front: 'Hur pullar du från remote?', back: 'git pull\nHämtar och mergar ändringar.', category: 'Pull', difficulty: 'easy' },
    { id: 't25-9', front: 'Hur visar du loggen?', back: 'git log\ngit log --oneline (kort)', category: 'Log', difficulty: 'easy' },
    { id: 't25-10', front: 'Hur skapar du branch?', back: 'git branch <namn>\ngit checkout -b <namn> (skapa+byt)', category: 'Branches', difficulty: 'easy' },
    // Medium (12)
    { id: 't25-11', front: 'Hur byter du branch?', back: 'git checkout <branch>\ngit switch <branch> (nyare)', category: 'Branches', difficulty: 'medium' },
    { id: 't25-12', front: 'Hur mergar du branch?', back: 'git checkout main\ngit merge feature-branch', category: 'Merge', difficulty: 'medium' },
    { id: 't25-13', front: 'Hur visar du diff?', back: 'git diff (unstaged)\ngit diff --staged (staged)', category: 'Diff', difficulty: 'medium' },
    { id: 't25-14', front: 'Hur ångrar du unstaged ändringar?', back: 'git checkout -- <fil>\ngit restore <fil> (nyare)', category: 'Ångra', difficulty: 'medium' },
    { id: 't25-15', front: 'Hur unstagar du fil?', back: 'git reset HEAD <fil>\ngit restore --staged <fil>', category: 'Ångra', difficulty: 'medium' },
    { id: 't25-16', front: 'Hur tar du bort branch?', back: 'git branch -d <branch>\n-D för force delete', category: 'Branches', difficulty: 'medium' },
    { id: 't25-17', front: 'Hur visar du remote URL?', back: 'git remote -v', category: 'Remote', difficulty: 'medium' },
    { id: 't25-18', front: 'Hur lägger du till remote?', back: 'git remote add origin <url>', category: 'Remote', difficulty: 'medium' },
    { id: 't25-19', front: 'Hur hämtar du utan merge?', back: 'git fetch\nHämtar men mergar inte.', category: 'Fetch', difficulty: 'medium' },
    { id: 't25-20', front: 'Vad gör git stash?', back: 'Sparar undan ändringar temporärt.\ngit stash\ngit stash pop', category: 'Stash', difficulty: 'medium' },
    { id: 't25-21', front: 'Hur visar du branches?', back: 'git branch (lokala)\ngit branch -r (remote)\ngit branch -a (alla)', category: 'Branches', difficulty: 'medium' },
    { id: 't25-22', front: 'Vad är .gitignore?', back: 'Fil som listar vad Git ska ignorera.\n*.log\nnode_modules/', category: 'Config', difficulty: 'medium' },
    // Hard (8)
    { id: 't25-23', front: 'Hur rebasar du?', back: 'git checkout feature\ngit rebase main\nLinjär historik.', category: 'Rebase', difficulty: 'hard' },
    { id: 't25-24', front: 'Skillnad merge vs rebase?', back: 'Merge: bevarar historik, merge commit\nRebase: linjär, skriver om commits', category: 'Koncept', difficulty: 'hard' },
    { id: 't25-25', front: 'Hur cherry-pickar du commit?', back: 'git cherry-pick <commit-hash>\nTar en specifik commit.', category: 'Cherry-pick', difficulty: 'hard' },
    { id: 't25-26', front: 'Hur ångrar du senaste commit?', back: 'git reset --soft HEAD~1 (behåller ändringar)\ngit reset --hard HEAD~1 (tar bort)', category: 'Ångra', difficulty: 'hard' },
    { id: 't25-27', front: 'Hur ändrar du senaste commit?', back: 'git commit --amend\nÄndrar meddelande/lägger till filer.', category: 'Commit', difficulty: 'hard' },
    { id: 't25-28', front: 'Hur löser du merge-konflikt?', back: '1. Öppna filen\n2. Välj kod (HEAD eller incoming)\n3. git add <fil>\n4. git commit', category: 'Konflikter', difficulty: 'hard' },
    { id: 't25-29', front: 'Hur interaktiv rebasar du?', back: 'git rebase -i HEAD~3\nSquash, edit, reorder commits.', category: 'Rebase', difficulty: 'hard' },
    { id: 't25-30', front: 'Hur skapar du tag?', back: 'git tag v1.0.0\ngit tag -a v1.0.0 -m "Release"\ngit push --tags', category: 'Tags', difficulty: 'hard' }
]
