...
export const USER_PERMISSIONS_QUESTIONS: LinuxCommandQuestion[] = [
    ...
    { id: "cmd-usr-a4", question: "Hur sätter du sticky bit?", options: ["chmod +t katalog", "chmod 1777 katalog", "chmod sticky katalog", "Båda A och B fungerar"], correctIndex: 3, explanation: "+t eller 1777 sätter sticky bit.", difficulty: "advanced", category: "Permissions" },
