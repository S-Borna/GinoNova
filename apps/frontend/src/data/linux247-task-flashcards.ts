...
const TASK_1_FLASHCARDS: TaskFlashcard[] = [
  // Easy (10)
  { id: 'l1-1', front: 'Hur visar du aktuell katalog?', back: 'pwd\n(print working directory)', category: 'Navigation', difficulty: 'G' },
  { id: 'l1-2', front: 'Hur byter du katalog?', back: 'cd <katalog>\ncd /var/log', category: 'Navigation', difficulty: 'G' },
  { id: 'l1-3', front: 'Hur går du upp en katalognivå?', back: 'cd ..', category: 'Navigation', difficulty: 'G' },
  { id: 'l1-4', front: 'Hur går du till hemkatalogen?', back: 'cd\neller: cd ~', category: 'Navigation', difficulty: 'G' },
  { id: 'l1-5', front: 'Hur listar du filer?', back: 'ls\nls -la (detaljerat + dolda)', category: 'Listing', difficulty: 'G' },
  { id: 'l1-6', front: 'Hur kopierar du en fil?', back: 'cp källa mål\ncp fil.txt kopia.txt', category: 'Kopiering', difficulty: 'G' },
  { id: 'l1-7', front: 'Hur flyttar/byter namn på fil?', back: 'mv källa mål\nmv gammal.txt ny.txt', category: 'Flytta', difficulty: 'G' },
  { id: 'l1-8', front: 'Hur tar du bort fil?', back: 'rm fil.txt\nrm -i fil.txt (bekräftelse)', category: 'Ta bort', difficulty: 'G' },
  { id: 'l1-9', front: 'Hur skapar du katalog?', back: 'mkdir katalog\nmkdir -p a/b/c (med föräldrar)', category: 'Skapa', difficulty: 'G' },
  { id: 'l1-10', front: 'Hur tar du bort tom katalog?', back: 'rmdir katalog\nrm -r katalog (med innehåll)', category: 'Ta bort', difficulty: 'G' },
  // Medium (12)
  { id: 'l1-11', front: 'Vad betyder ls -l kolumnerna?', back: 'permissions links owner group size date name\n-rw-r--r-- 1 user group 1234 Jan 1 file', category: 'Listing', difficulty: 'G' },
  { id: 'l1-12', front: 'Hur visar du dolda filer?', back: 'ls -a\nDolda filer börjar med .', category: 'Listing', difficulty: 'G' },
  { id: 'l1-13', front: 'Hur kopierar du katalog rekursivt?', back: 'cp -r källa/ mål/', category: 'Kopiering', difficulty: 'G' },
  { id: 'l1-14', front: 'Hur hittar du filer med find?', back: 'find /sökväg -name "*.txt"\nfind . -type f -name "config*"', category: 'Sökning', difficulty: 'G' },
  { id: 'l1-15', front: 'Hur hittar du var ett kommando finns?', back: 'which kommando\nwhich python', category: 'Sökning', difficulty: 'G' },
  { id: 'l1-16', front: 'Vad finns i /etc?', back: 'Systemkonfigurationsfiler.\n/etc/passwd, /etc/hosts, /etc/ssh/', category: 'Struktur', difficulty: 'G' },
  { id: 'l1-17', front: 'Vad finns i /var/log?', back: 'Loggfiler.\nsyslog, auth.log, nginx/', category: 'Struktur', difficulty: 'G' },
  { id: 'l1-18', front: 'Vad finns i /home?', back: 'Användarnas hemkataloger.\n/home/username/', category: 'Struktur', difficulty: 'G' },
  { id: 'l1-19', front: 'Vad är skillnaden på absolut och relativ sökväg?', back: 'Absolut: börjar med / (/var/log)\nRelativ: från nuvarande (./log)', category: 'Sökvägar', difficulty: 'G' },
  { id: 'l1-20', front: 'Hur skapar du tom fil?', back: 'touch fil.txt\neller: > fil.txt', category: 'Skapa', difficulty: 'G' },
  { id: 'l1-21', front: 'Hur visar du filtyp?', back: 'file filnamn\nVisar om text, binär, script etc.', category: 'Info', difficulty: 'G' },
  { id: 'l1-22', front: 'Hur visar du diskutrymme?', back: 'df -h\n-h = human readable', category: 'Disk', difficulty: 'G' },
  // Hard (8)
  { id: 'l1-23', front: 'Hur hittar du filer större än 100MB?', back: 'find / -size +100M', category: 'Sökning', difficulty: 'VG' },
  { id: 'l1-24', front: 'Hur hittar du filer ändrade senaste timmen?', back: 'find . -mmin -60\n-mmin = minuter, -mtime = dagar', category: 'Sökning', difficulty: 'VG' },
  { id: 'l1-25', front: 'Hur kör du kommando på hittade filer?', back: 'find . -name "*.log" -exec rm {} \\;\neller: find . -name "*.log" | xargs rm', category: 'Sökning', difficulty: 'VG' },
  { id: 'l1-26', front: 'Vad gör locate vs find?', back: 'locate: snabb (databas), updatedb uppdaterar\nfind: långsam men exakt', category: 'Sökning', difficulty: 'VG' },
  { id: 'l1-27', front: 'Hur skapar du symbolisk länk?', back: 'ln -s mål länk\nln -s /var/log logs', category: 'Länkar', difficulty: 'VG' },
  { id: 'l1-28', front: 'Skillnad hård vs symbolisk länk?', back: 'Hård: samma inode, kvarstår vid delete\nSymbolisk: pekare, bryts om mål tas bort', category: 'Länkar', difficulty: 'VG' },
  { id: 'l1-29', front: 'Hur visar du katalogstorlek?', back: 'du -sh katalog\n-s summary, -h human', category: 'Disk', difficulty: 'VG' },
  { id: 'l1-30', front: 'Vad finns i /proc?', back: 'Virtuellt filsystem med procesinfo.\n/proc/cpuinfo, /proc/meminfo', category: 'Struktur', difficulty: 'VG' }
]
...
const TASK_2_FLASHCARDS: TaskFlashcard[] = [
  // Easy (10)
  { id: 'l2-1', front: 'Hur visar du filinnehåll?', back: 'cat fil.txt', category: 'Visa', difficulty: 'G' },
  { id: 'l2-2', front: 'Hur visar du första 10 raderna?', back: 'head fil.txt\nhead -n 20 fil.txt (20 rader)', category: 'Visa', difficulty: 'G' },
  { id: 'l2-3', front: 'Hur visar du sista 10 raderna?', back: 'tail fil.txt\ntail -n 20 fil.txt', category: 'Visa', difficulty: 'G' },
  { id: 'l2-4', front: 'Hur följer du loggfil live?', back: 'tail -f fil.log\n-f = follow', category: 'Visa', difficulty: 'G' },
  { id: 'l2-5', front: 'Hur söker du text i fil?', back: 'grep "text" fil.txt', category: 'grep', difficulty: 'G' },
  { id: 'l2-6', front: 'Hur räknar du rader i fil?', back: 'wc -l fil.txt\n-l = lines', category: 'Räkna', difficulty: 'G' },
  { id: 'l2-7', front: 'Hur sorterar du filinnehåll?', back: 'sort fil.txt', category: 'Sortera', difficulty: 'G' },
  { id: 'l2-8', front: 'Hur tar du bort dubbletter?', back: 'uniq fil.txt\nOBS: kräver sorterad input!', category: 'Uniq', difficulty: 'G' },
  { id: 'l2-9', front: 'Hur bläddrar du i stor fil?', back: 'less fil.txt\nq = quit, / = sök', category: 'Visa', difficulty: 'G' },
  { id: 'l2-10', front: 'Hur skriver du text till fil?', back: 'echo "text" > fil.txt (skriv över)\necho "text" >> fil.txt (lägg till)', category: 'Skriva', difficulty: 'G' },
  // Medium (12)
  { id: 'l2-11', front: 'Hur söker du case-insensitive?', back: 'grep -i "text" fil.txt', category: 'grep', difficulty: 'G' },
  { id: 'l2-12', front: 'Hur söker du rekursivt i katalog?', back: 'grep -r "text" katalog/', category: 'grep', difficulty: 'G' },
  { id: 'l2-13', front: 'Hur visar du radnummer med grep?', back: 'grep -n "text" fil.txt', category: 'grep', difficulty: 'G' },
  { id: 'l2-14', front: 'Hur inverterar du grep (EJ matchar)?', back: 'grep -v "text" fil.txt\n-v = invert', category: 'grep', difficulty: 'G' },
  { id: 'l2-15', front: 'Hur plockar du ut kolumn med cut?', back: 'cut -d":" -f1 fil.txt\n-d = delimiter, -f = field', category: 'cut', difficulty: 'G' },
  { id: 'l2-16', front: 'Hur ersätter du text med sed?', back: 'sed "s/gammalt/nytt/g" fil.txt\ng = global (alla)', category: 'sed', difficulty: 'G' },
  { id: 'l2-17', front: 'Hur sorterar du numeriskt?', back: 'sort -n fil.txt', category: 'Sortera', difficulty: 'G' },
  { id: 'l2-18', front: 'Hur sorterar du omvänt?', back: 'sort -r fil.txt\n-r = reverse', category: 'Sortera', difficulty: 'G' },
  { id: 'l2-19', front: 'Hur räknar du ord?', back: 'wc -w fil.txt\n-w = words', category: 'Räkna', difficulty: 'G' },
  { id: 'l2-20', front: 'Hur sammanfogar du filer?', back: 'cat fil1.txt fil2.txt > combined.txt', category: 'Kombinera', difficulty: 'G' },
  { id: 'l2-21', front: 'Hur jämför du två filer?', back: 'diff fil1.txt fil2.txt', category: 'Jämför', difficulty: 'G' },
  { id: 'l2-22', front: 'Vad gör pipe |?', back: 'Skickar output till nästa kommando.\ncat fil | grep "text" | wc -l', category: 'Pipe', difficulty: 'G' },
  // Hard (8)
  { id: 'l2-23', front: 'Grundläggande awk-syntax?', back: 'awk \'{print $1}\' fil.txt\nSkriver ut första kolumnen.', category: 'awk', difficulty: 'VG' },
  { id: 'l2-24', front: 'Hur filtrerar du med awk?', back: 'awk \'$3 > 100\' fil.txt\nRader där kolumn 3 > 100', category: 'awk', difficulty: 'VG' },
  { id: 'l2-25', front: 'Hur gör du in-place edit med sed?', back: 'sed -i "s/old/new/g" fil.txt\n-i = in-place', category: 'sed', difficulty: 'VG' },
  { id: 'l2-26', front: 'Hur tar du bort rader med sed?', back: 'sed "/pattern/d" fil.txt\nd = delete', category: 'sed', difficulty: 'VG' },
  { id: 'l2-27', front: 'Hur visar du kontext runt grep-match?', back: 'grep -A 3 -B 2 "text" fil.txt\n-A = after, -B = before', category: 'grep', difficulty: 'VG' },
  { id: 'l2-28', front: 'Hur söker du med regex i grep?', back: 'grep -E "^[0-9]+" fil.txt\n-E = extended regex', category: 'grep', difficulty: 'VG' },
  { id: 'l2-29', front: 'Hur transponerar du kolumner?', back: 'awk \'{print $2, $1}\' fil.txt\nByter ordning på kolumner.', category: 'awk', difficulty: 'VG' },
  { id: 'l2-30', front: 'Hur summerar du kolumn med awk?', back: 'awk \'{sum+=$1} END {print sum}\' fil.txt', category: 'awk', difficulty: 'VG' }
]
...
const TASK_4_FLASHCARDS: TaskFlashcard[] = [
  // Easy (10)
  { id: 'l4-1', front: 'Hur visar du systemets hostname?', back: 'hostname\neller: cat /etc/hostname', category: 'System', difficulty: 'G' },
  { id: 'l4-2', front: 'Hur visar du uptime?', back: 'uptime\nVisar hur länge systemet varit igång.', category: 'System', difficulty: 'G' },
  { id: 'l4-3', front: 'Hur visar du kernel-version?', back: 'uname -r\neller: uname -a (all info)', category: 'Kernel', difficulty: 'G' },
  { id: 'l4-4', front: 'Hur visar du OS-version?', back: 'cat /etc/os-release\neller: lsb_release -a', category: 'System', difficulty: 'G' },
  { id: 'l4-5', front: 'Hur visar du inloggade användare?', back: 'who\neller: w (mer detaljer)', category: 'Users', difficulty: 'G' },
  { id: 'l4-6', front: 'Hur visar du nuvarande användare?', back: 'whoami\neller: id', category: 'Users', difficulty: 'G' },
  { id: 'l4-7', front: 'Hur visar du datum och tid?', back: 'date', category: 'System', difficulty: 'G' },
  { id: 'l4-8', front: 'Hur visar du kalendern?', back: 'cal\ncal 2024 (hela året)', category: 'System', difficulty: 'G' },
  { id: 'l4-9', front: 'Hur visar du minnesanvändning?', back: 'free -h\n-h = human readable', category: 'Minne', difficulty: 'G' },
  { id: 'l4-10', front: 'Hur visar du diskutrymme?', back: 'df -h', category: 'Disk', difficulty: 'G' },
  // Medium (12)
  { id: 'l4-11', front: 'Hur visar du CPU-info?', back: 'lscpu\neller: cat /proc/cpuinfo', category: 'CPU', difficulty: 'G' },
  { id: 'l4-12', front: 'Hur visar du antal CPU-kärnor?', back: 'nproc\neller: lscpu | grep "^CPU(s):"', category: 'CPU', difficulty: 'G' },
  { id: 'l4-13', front: 'Hur visar du minnesinfo detaljerat?', back: 'cat /proc/meminfo', category: 'Minne', difficulty: 'G' },
  { id: 'l4-14', front: 'Vad visar /proc/cpuinfo?', back: 'Detaljerad CPU-info:\nmodell, hastighet, cache, flaggor', category: 'CPU', difficulty: 'G' },
  { id: 'l4-15', front: 'Hur listar du PCI-enheter?', back: 'lspci\nVisar grafikkort, nätverkskort etc.', category: 'Hårdvara', difficulty: 'G' },
  { id: 'l4-16', front: 'Hur listar du USB-enheter?', back: 'lsusb', category: 'Hårdvara', difficulty: 'G' },
  { id: 'l4-17', front: 'Hur listar du blockenheter?', back: 'lsblk\nVisar diskar och partitioner.', category: 'Disk', difficulty: 'G' },
  { id: 'l4-18', front: 'Hur ändrar du hostname temporärt?', back: 'hostname nyttnamn\n(Försvinner vid omstart)', category: 'System', difficulty: 'G' },
  { id: 'l4-19', front: 'Hur ändrar du hostname permanent?', back: 'hostnamectl set-hostname nyttnamn', category: 'System', difficulty: 'G' },
  { id: 'l4-20', front: 'Hur visar du tidszon?', back: 'timedatectl\neller: cat /etc/timezone', category: 'System', difficulty: 'G' },
  { id: 'l4-21', front: 'Hur ändrar du tidszon?', back: 'timedatectl set-timezone Europe/Stockholm', category: 'System', difficulty: 'G' },
  { id: 'l4-22', front: 'Vad visar load average?', back: 'Genomsnittlig systemlast 1, 5, 15 min.\nVisa: uptime eller top', category: 'System', difficulty: 'G' },
  // Hard (8)
  { id: 'l4-23', front: 'Hur visar du detaljerad hårdvaruinfo?', back: 'sudo dmidecode\neller: lshw', category: 'Hårdvara', difficulty: 'VG' },
  { id: 'l4-24', front: 'Hur visar du kernel-moduler?', back: 'lsmod\nListar laddade kernel modules.', category: 'Kernel', difficulty: 'VG' },
  { id: 'l4-25', front: 'Hur laddar du kernel-modul?', back: 'sudo modprobe modulnamn', category: 'Kernel', difficulty: 'VG' },
  { id: 'l4-26', front: 'Hur tar du bort kernel-modul?', back: 'sudo modprobe -r modulnamn\neller: rmmod', category: 'Kernel', difficulty: 'VG' },
  { id: 'l4-27', front: 'Vad är /sys-filsystemet?', back: 'Virtuellt FS med kernel/hårdvara-info.\nExporterar kernel-objekt.', category: 'Kernel', difficulty: 'VG' },
  { id: 'l4-28', front: 'Hur visar du kernel ring buffer?', back: 'dmesg\ndmesg | tail (senaste)', category: 'Kernel', difficulty: 'VG' },
  { id: 'l4-29', front: 'Hur visar du BIOS-info?', back: 'sudo dmidecode -t bios', category: 'Hårdvara', difficulty: 'VG' },
  { id: 'l4-30', front: 'Hur visar du kernel-parametrar?', back: 'sysctl -a\ncat /proc/sys/...', category: 'Kernel', difficulty: 'VG' }
]
...
const TASK_5_FLASHCARDS: TaskFlashcard[] = [
  // Easy (10)
  { id: 'l5-1', front: 'Var finns systemloggar?', back: '/var/log/\nsyslog, auth.log, kern.log etc.', category: 'Platser', difficulty: 'G' },
  { id: 'l5-2', front: 'Hur följer du logg i realtid?', back: 'tail -f /var/log/syslog', category: 'Visa', difficulty: 'G' },
  { id: 'l5-3', front: 'Vad innehåller syslog?', back: 'Allmänna systemmeddelanden.\nHuvudloggen på många system.', category: 'Loggar', difficulty: 'G' },
  { id: 'l5-4', front: 'Vad innehåller auth.log?', back: 'Autentiseringsloggar.\nLogin-försök, sudo-användning.', category: 'Loggar', difficulty: 'G' },
  { id: 'l5-5', front: 'Hur visar du systemd journal?', back: 'journalctl', category: 'journalctl', difficulty: 'G' },
  { id: 'l5-6', front: 'Hur följer du journal live?', back: 'journalctl -f\n-f = follow', category: 'journalctl', difficulty: 'G' },
  { id: 'l5-7', front: 'Hur visar du loggar för en tjänst?', back: 'journalctl -u nginx\n-u = unit', category: 'journalctl', difficulty: 'G' },
  { id: 'l5-8', front: 'Vad innehåller kern.log?', back: 'Kernel-meddelanden.\nHårdvarufel, driver-info.', category: 'Loggar', difficulty: 'G' },
  { id: 'l5-9', front: 'Hur söker du i loggar?', back: 'grep "error" /var/log/syslog', category: 'Söka', difficulty: 'G' },
  { id: 'l5-10', front: 'Vad är dmesg?', back: 'Kernel ring buffer.\nVisar boot-meddelanden, hårdvara.', category: 'Loggar', difficulty: 'G' },
  // Medium (12)
  { id: 'l5-11', front: 'Hur visar du loggar från senaste boot?', back: 'journalctl -b\n-b = current boot', category: 'journalctl', difficulty: 'G' },
  { id: 'l5-12', front: 'Hur visar du loggar från förra boot?', back: 'journalctl -b -1\n-1 = previous boot', category: 'journalctl', difficulty: 'G' },
  { id: 'l5-13', front: 'Hur filtrerar du journal på prioritet?', back: 'journalctl -p err\nerr, warning, info, debug etc.', category: 'journalctl', difficulty: 'G' },
  { id: 'l5-14', front: 'Hur visar du loggar för tidsperiod?', back: 'journalctl --since "1 hour ago"\njournalctl --since "2024-01-01"', category: 'journalctl', difficulty: 'G' },
  { id: 'l5-15', front: 'Vad hanterar logrotate?', back: 'Automatisk rotation av loggar.\nKomprimering, borttagning av gamla.', category: 'Management', difficulty: 'G' },
  { id: 'l5-16', front: 'Var konfigureras logrotate?', back: '/etc/logrotate.conf\n/etc/logrotate.d/', category: 'Management', difficulty: 'G' },
  { id: 'l5-17', front: 'Hur visar du kernel-meddelanden?', back: 'dmesg\njournalctl -k', category: 'Kernel', difficulty: 'G' },
  { id: 'l5-18', front: 'Vad loggas i /var/log/secure?', back: 'Security-relaterade loggar.\nSSH, sudo, PAM (RedHat/CentOS).', category: 'Loggar', difficulty: 'G' },
  { id: 'l5-19', front: 'Hur visar du diskutrymme för loggar?', back: 'du -sh /var/log/\njournalctl --disk-usage', category: 'Management', difficulty: 'G' },
  { id: 'l5-20', front: 'Vad är rsyslog?', back: 'System logging daemon.\nKonfigureras i /etc/rsyslog.conf', category: 'Daemon', difficulty: 'G' },
  { id: 'l5-21', front: 'Hur skickar du meddelande till syslog?', back: 'logger "Mitt meddelande"', category: 'Skriva', difficulty: 'G' },
  { id: 'l5-22', front: 'Vilka är syslog-prioriteter?', back: 'emerg, alert, crit, err,\nwarning, notice, info, debug', category: 'Koncept', difficulty: 'G' },
  // Hard (8)
  { id: 'l5-23', front: 'Hur begränsar du journal-storlek?', back: 'journalctl --vacuum-size=100M\njournalctl --vacuum-time=7d', category: 'Management', difficulty: 'VG' },
  { id: 'l5-24', front: 'Var konfigureras journald?', back: '/etc/systemd/journald.conf\nSystemMaxUse, MaxRetentionSec', category: 'Konfig', difficulty: 'VG' },
  { id: 'l5-25', front: 'Hur visar du loggar i JSON-format?', back: 'journalctl -o json\neller: -o json-pretty', category: 'journalctl', difficulty: 'VG' },
  { id: 'l5-26', front: 'Hur exporterar du journal-loggar?', back: 'journalctl > export.log\njournalctl -o export > file', category: 'Export', difficulty: 'VG' },
  { id: 'l5-27', front: 'Hur konfigurerar du remote logging?', back: 'rsyslog: @@remote-host:514\neller: systemd-journal-remote', category: 'Remote', difficulty: 'VG' },
  { id: 'l5-28', front: 'Vad är facility i syslog?', back: 'Kategori: kern, user, mail, daemon,\nauth, local0-7 etc.', category: 'Koncept', difficulty: 'VG' },
  { id: 'l5-29', front: 'Hur visar du journal för specifik PID?', back: 'journalctl _PID=1234', category: 'journalctl', difficulty: 'VG' },
  { id: 'l5-30', front: 'Hur persistent-lagrar du journal?', back: 'mkdir -p /var/log/journal\nsystemctl restart systemd-journald', category: 'Konfig', difficulty: 'VG' }
]
...
const TASK_6_FLASHCARDS: TaskFlashcard[] = [
  // Easy (10)
  { id: 'l6-1', front: 'Hur ansluter du via SSH?', back: 'ssh user@host\nssh admin@192.168.1.10', category: 'Anslut', difficulty: 'G' },
  { id: 'l6-2', front: 'Vilken port använder SSH?', back: 'Port 22 (standard)', category: 'Koncept', difficulty: 'G' },
  { id: 'l6-3', front: 'Hur ansluter du på annan port?', back: 'ssh -p 2222 user@host', category: 'Anslut', difficulty: 'G' },
  { id: 'l6-4', front: 'Hur genererar du SSH-nyckelpar?', back: 'ssh-keygen\nSkapar id_rsa och id_rsa.pub', category: 'Nycklar', difficulty: 'G' },
  { id: 'l6-5', front: 'Var lagras SSH-nycklar?', back: '~/.ssh/\nid_rsa (privat), id_rsa.pub (publik)', category: 'Nycklar', difficulty: 'G' },
  { id: 'l6-6', front: 'Hur kopierar du publik nyckel till server?', back: 'ssh-copy-id user@host', category: 'Nycklar', difficulty: 'G' },
  { id: 'l6-7', front: 'Hur kopierar du fil via SSH?', back: 'scp fil.txt user@host:/path/\nscp user@host:/fil.txt .', category: 'scp', difficulty: 'G' },
  { id: 'l6-8', front: 'Var finns SSH server config?', back: '/etc/ssh/sshd_config', category: 'Konfig', difficulty: 'G' },
  { id: 'l6-9', front: 'Var finns SSH client config?', back: '~/.ssh/config\neller: /etc/ssh/ssh_config', category: 'Konfig', difficulty: 'G' },
  { id: 'l6-10', front: 'Hur avslutar du SSH-session?', back: 'exit\neller: Ctrl+D', category: 'Anslut', difficulty: 'G' },
  // Medium (12)
  { id: 'l6-11', front: 'Hur genererar du Ed25519-nyckel?', back: 'ssh-keygen -t ed25519\nMer säker och snabbare.', category: 'Nycklar', difficulty: 'G' },
  { id: 'l6-12', front: 'Vad är authorized_keys?', back: '~/.ssh/authorized_keys\nInnehåller tillåtna publika nycklar.', category: 'Nycklar', difficulty: 'G' },
  { id: 'l6-13', front: 'Hur kopierar du katalog via scp?', back: 'scp -r katalog/ user@host:/path/', category: 'scp', difficulty: 'G' },
  { id: 'l6-14', front: 'Hur kör du kommando via SSH?', back: 'ssh user@host "kommando"\nssh admin@srv "uptime"', category: 'Anslut', difficulty: 'G' },
...
const TASK_7_FLASHCARDS: TaskFlashcard[] = [
  // Easy (10)
  { id: 'l7-1', front: 'Vilka två brandväggar finns i Linux?', back: 'UFW (Ubuntu/Debian)\nfirewalld (RHEL/CentOS)', category: 'Koncept', difficulty: 'G' },
  { id: 'l7-2', front: 'Hur aktiverar du UFW?', back: 'sudo ufw enable', category: 'UFW', difficulty: 'G' },
  { id: 'l7-3', front: 'Hur inaktiverar du UFW?', back: 'sudo ufw disable', category: 'UFW', difficulty: 'G' },
  { id: 'l7-4', front: 'Hur visar du UFW-status?', back: 'sudo ufw status\nsudo ufw status verbose', category: 'UFW', difficulty: 'G' },
  { id: 'l7-5', front: 'Hur tillåter du port 22 i UFW?', back: 'sudo ufw allow 22\nsudo ufw allow ssh', category: 'UFW', difficulty: 'G' },
  { id: 'l7-6', front: 'Hur blockerar du port 80 i UFW?', back: 'sudo ufw deny 80', category: 'UFW', difficulty: 'G' },
  { id: 'l7-7', front: 'Hur kontrollerar du firewalld status?', back: 'sudo firewall-cmd --state\nsudo systemctl status firewalld', category: 'firewalld', difficulty: 'G' },
  { id: 'l7-8', front: 'Hur listar du firewalld regler?', back: 'sudo firewall-cmd --list-all', category: 'firewalld', difficulty: 'G' },
  { id: 'l7-9', front: 'Vad är default policy?', back: 'Vad som händer med trafik som\nej matchar någon regel.\nVanligen: deny incoming', category: 'Koncept', difficulty: 'G' },
  { id: 'l7-10', front: 'Hur återställer du UFW till default?', back: 'sudo ufw reset', category: 'UFW', difficulty: 'G' },
  // Medium (12)
  { id: 'l7-11', front: 'Hur tillåter du HTTP och HTTPS i UFW?', back: 'sudo ufw allow http\nsudo ufw allow https\neller: allow 80,443/tcp', category: 'UFW', difficulty: 'G' },
  { id: 'l7-12', front: 'Hur tillåter du IP-range i UFW?', back: 'sudo ufw allow from 192.168.1.0/24', category: 'UFW', difficulty: 'G' },
  { id: 'l7-13', front: 'Hur tar du bort UFW-regel?', back: 'sudo ufw delete allow 22\nsudo ufw delete 5 (nummer)', category: 'UFW', difficulty: 'G' },
  { id: 'l7-14', front: 'Hur tillåter du port i firewalld?', back: 'sudo firewall-cmd --add-port=80/tcp', category: 'firewalld', difficulty: 'G' },
  { id: 'l7-15', front: 'Hur gör du firewalld-regel permanent?', back: 'sudo firewall-cmd --permanent --add-port=80/tcp\nfirewall-cmd --reload', category: 'firewalld', difficulty: 'G' },
  { id: 'l7-16', front: 'Hur tillåter du tjänst i firewalld?', back: 'sudo firewall-cmd --add-service=http', category: 'firewalld', difficulty: 'G' },
  { id: 'l7-17', front: 'Vad är firewalld zones?', back: 'Säkerhetsnivåer för nätverk:\npublic, trusted, internal etc.', category: 'firewalld', difficulty: 'G' },
  { id: 'l7-18', front: 'Hur listar du firewalld zones?', back: 'sudo firewall-cmd --get-zones', category: 'firewalld', difficulty: 'G' },
  { id: 'l7-19', front: 'Hur visar du aktiv zone?', back: 'sudo firewall-cmd --get-active-zones', category: 'firewalld', difficulty: 'G' },
  { id: 'l7-20', front: 'Hur tillåter du specifik IP till port i UFW?', back: 'sudo ufw allow from 10.0.0.5 to any port 22', category: 'UFW', difficulty: 'G' },
  { id: 'l7-21', front: 'Hur loggar du UFW-trafik?', back: 'sudo ufw logging on\nLoggar till /var/log/ufw.log', category: 'UFW', difficulty: 'G' },
  { id: 'l7-22', front: 'Hur visar du numrerade UFW-regler?', back: 'sudo ufw status numbered', category: 'UFW', difficulty: 'G' },
  // Hard (8)
  { id: 'l7-23', front: 'Hur konfigurerar du rate limiting i UFW?', back: 'sudo ufw limit ssh\nMax 6 anslutningar/30s', category: 'UFW', difficulty: 'VG' },
  { id: 'l7-24', front: 'Hur skapar du custom firewalld service?', back: 'Skapa XML i /etc/firewalld/services/\nfirewall-cmd --reload', category: 'firewalld', difficulty: 'VG' },
  { id: 'l7-25', front: 'Vad är iptables?', back: 'Underliggande firewall-framework.\nUFW och firewalld är frontends.', category: 'Koncept', difficulty: 'VG' },
  { id: 'l7-26', front: 'Hur listar du iptables-regler?', back: 'sudo iptables -L -n -v', category: 'iptables', difficulty: 'VG' },
  { id: 'l7-27', front: 'Hur blockerar du IP med iptables?', back: 'sudo iptables -A INPUT -s 1.2.3.4 -j DROP', category: 'iptables', difficulty: 'VG' },
  { id: 'l7-28', front: 'Hur sparar du iptables-regler?', back: 'sudo iptables-save > /etc/iptables.rules\nsudo netfilter-persistent save', category: 'iptables', difficulty: 'VG' },
  { id: 'l7-29', front: 'Hur sätter du upp port forwarding i firewalld?', back: 'firewall-cmd --add-forward-port=\nport=80:proto=tcp:toport=8080', category: 'firewalld', difficulty: 'VG' },
  { id: 'l7-30', front: 'Hur aktiverar du masquerading (NAT)?', back: 'firewall-cmd --add-masquerade\neller: ufw route allow', category: 'NAT', difficulty: 'VG' }
]
...
const TASK_8_FLASHCARDS: TaskFlashcard[] = [
  // Easy (10)
  { id: 'l8-1', front: 'Hur visar du IP-adresser?', back: 'ip addr\neller: ip a', category: 'IP', difficulty: 'G' },
  { id: 'l8-2', front: 'Hur visar du nätverksinterface?', back: 'ip link\neller: ip l', category: 'Interface', difficulty: 'G' },
  { id: 'l8-3', front: 'Hur testar du anslutning?', back: 'ping google.com\nping 8.8.8.8', category: 'Testa', difficulty: 'G' },
  { id: 'l8-4', front: 'Hur visar du routing-tabell?', back: 'ip route\neller: ip r', category: 'Routing', difficulty: 'G' },
  { id: 'l8-5', front: 'Hur visar du DNS-servers?', back: 'cat /etc/resolv.conf', category: 'DNS', difficulty: 'G' },
  { id: 'l8-6', front: 'Hur slår du upp DNS?', back: 'nslookup google.com\neller: dig google.com', category: 'DNS', difficulty: 'G' },
  { id: 'l8-7', front: 'Hur visar du hostname?', back: 'hostname', category: 'System', difficulty: 'G' },
  { id: 'l8-8', front: 'Var konfigureras hosts?', back: '/etc/hosts\nLokal DNS-override', category: 'DNS', difficulty: 'G' },
  { id: 'l8-9', front: 'Hur visar du nätverksanslutningar?', back: 'ss -tuln\neller: netstat -tuln', category: 'Anslut', difficulty: 'G' },
  { id: 'l8-10', front: 'Hur tracear du route till host?', back: 'traceroute google.com\neller: tracepath', category: 'Testa', difficulty: 'G' },
  // Medium (12)
  { id: 'l8-11', front: 'Vad betyder ss -tuln?', back: '-t TCP, -u UDP\n-l listening, -n numeric', category: 'Anslut', difficulty: 'G' },
  { id: 'l8-12', front: 'Hur visar du vilken process använder port?', back: 'ss -tlnp | grep :80\nlsof -i :80', category: 'Anslut', difficulty: 'G' },
  { id: 'l8-13', front: 'Hur sätter du statisk IP med ip?', back: 'ip addr add 192.168.1.10/24 dev eth0\n(temporärt)', category: 'IP', difficulty: 'G' },
  { id: 'l8-14', front: 'Hur aktiverar du interface?', back: 'ip link set eth0 up', category: 'Interface', difficulty: 'G' },
  { id: 'l8-15', front: 'Hur inaktiverar du interface?', back: 'ip link set eth0 down', category: 'Interface', difficulty: 'G' },
  { id: 'l8-16', front: 'Hur lägger du till default gateway?', back: 'ip route add default via 192.168.1.1', category: 'Routing', difficulty: 'G' },
  { id: 'l8-17', front: 'Vad är NetworkManager?', back: 'Tjänst för nätverkskonfiguration.\nnmcli, nmtui för hantering.', category: 'Service', difficulty: 'G' },
  { id: 'l8-18', front: 'Hur visar du NetworkManager status?', back: 'nmcli general status\nnmcli device status', category: 'nmcli', difficulty: 'G' },
  { id: 'l8-19', front: 'Hur listar du WiFi-nätverk?', back: 'nmcli device wifi list', category: 'nmcli', difficulty: 'G' },
  { id: 'l8-20', front: 'Hur ansluter du till WiFi?', back: 'nmcli device wifi connect SSID password PWD', category: 'nmcli', difficulty: 'G' },
  { id: 'l8-21', front: 'Hur visar du alla anslutningar?', back: 'nmcli connection show', category: 'nmcli', difficulty: 'G' },
  { id: 'l8-22', front: 'Vad gör curl?', back: 'HTTP-klient för requests.\ncurl https://api.example.com', category: 'HTTP', difficulty: 'G' },
  // Hard (8)
  { id: 'l8-23', front: 'Hur fångar du nätverkstrafik?', back: 'tcpdump -i eth0\nsudo tcpdump port 80', category: 'Debug', difficulty: 'VG' },
  { id: 'l8-24', front: 'Hur scannar du portar?', back: 'nmap 192.168.1.1\nnmap -sV för versioner', category: 'Scan', difficulty: 'VG' },
  { id: 'l8-25', front: 'Hur konfigurerar du permanent IP (Netplan)?', back: '/etc/netplan/*.yaml\nnetplan apply', category: 'Konfig', difficulty: 'VG' },
  { id: 'l8-26', front: 'Hur aktiverar du IP forwarding?', back: 'sysctl net.ipv4.ip_forward=1\neller: echo 1 > /proc/sys/net/ipv4/ip_forward', category: 'Routing', difficulty: 'VG' },
  { id: 'l8-27', front: 'Hur debuggar du DNS?', back: 'dig +trace google.com\nnslookup -debug', category: 'DNS', difficulty: 'VG' },
  { id: 'l8-28', front: 'Hur konfigurerar du bonding/teaming?', back: 'nmcli con add type bond\neller: /etc/netplan/', category: 'Avancerat', difficulty: 'VG' },
  { id: 'l8-29', front: 'Hur visar du ARP-cache?', back: 'ip neigh\neller: arp -a', category: 'ARP', difficulty: 'VG' },
  { id: 'l8-30', front: 'Hur skapar du VLAN interface?', back: 'ip link add link eth0 name eth0.100 type vlan id 100', category: 'VLAN', difficulty: 'VG' }
]
...
const TASK_9_FLASHCARDS: TaskFlashcard[] = [
  // Easy (10)
  { id: 'l9-1', front: 'Vilka pakethanterare finns?', back: 'apt (Debian/Ubuntu)\ndnf/yum (RHEL/Fedora)', category: 'Koncept', difficulty: 'G' },
  { id: 'l9-2', front: 'Hur uppdaterar du paketlistan (apt)?', back: 'sudo apt update', category: 'apt', difficulty: 'G' },
  { id: 'l9-3', front: 'Hur uppgraderar du paket (apt)?', back: 'sudo apt upgrade', category: 'apt', difficulty: 'G' },
  { id: 'l9-4', front: 'Hur installerar du paket (apt)?', back: 'sudo apt install paketnamn', category: 'apt', difficulty: 'G' },
  { id: 'l9-5', front: 'Hur tar du bort paket (apt)?', back: 'sudo apt remove paketnamn\nsudo apt purge (+ config)', category: 'apt', difficulty: 'G' },
  { id: 'l9-6', front: 'Hur söker du paket (apt)?', back: 'apt search sökord', category: 'apt', difficulty: 'G' },
  { id: 'l9-7', front: 'Hur installerar du paket (dnf)?', back: 'sudo dnf install paketnamn', category: 'dnf', difficulty: 'G' },
  { id: 'l9-8', front: 'Hur uppdaterar du system (dnf)?', back: 'sudo dnf upgrade\neller: dnf update', category: 'dnf', difficulty: 'G' },
  { id: 'l9-9', front: 'Hur tar du bort paket (dnf)?', back: 'sudo dnf remove paketnamn', category: 'dnf', difficulty: 'G' },
  { id: 'l9-10', front: 'Hur söker du paket (dnf)?', back: 'dnf search sökord', category: 'dnf', difficulty: 'G' },
  // Medium (12)
  { id: 'l9-11', front: 'Hur visar du info om paket (apt)?', back: 'apt show paketnamn', category: 'apt', difficulty: 'G' },
  { id: 'l9-12', front: 'Hur listar du installerade paket?', back: 'apt list --installed\ndnf list installed', category: 'Lista', difficulty: 'G' },
  { id: 'l9-13', front: 'Hur rensar du paket-cache (apt)?', back: 'sudo apt clean\nsudo apt autoclean', category: 'apt', difficulty: 'G' },
  { id: 'l9-14', front: 'Hur tar du bort oanvända beroenden?', back: 'sudo apt autoremove\nsudo dnf autoremove', category: 'Clean', difficulty: 'G' },
  { id: 'l9-15', front: 'Hur installerar du .deb-fil?', back: 'sudo dpkg -i paket.deb\neller: apt install ./paket.deb', category: 'dpkg', difficulty: 'G' },
  { id: 'l9-16', front: 'Hur installerar du .rpm-fil?', back: 'sudo rpm -i paket.rpm\neller: dnf install paket.rpm', category: 'rpm', difficulty: 'G' },
  { id: 'l9-17', front: 'Hur listar du filer i installerat paket?', back: 'dpkg -L paketnamn\nrpm -ql paketnamn', category: 'Info', difficulty: 'G' },
  { id: 'l9-18', front: 'Hur hittar du vilket paket äger fil?', back: 'dpkg -S /path/to/file\nrpm -qf /path/to/file', category: 'Info', difficulty: 'G' },
  { id: 'l9-19', front: 'Var konfigureras apt repositories?', back: '/etc/apt/sources.list\n/etc/apt/sources.list.d/', category: 'Repos', difficulty: 'G' },
  { id: 'l9-20', front: 'Hur lägger du till PPA (Ubuntu)?', back: 'sudo add-apt-repository ppa:user/repo\nsudo apt update', category: 'Repos', difficulty: 'G' },
  { id: 'l9-21', front: 'Hur visar du paket-changelog?', back: 'apt changelog paketnamn', category: 'Info', difficulty: 'G' },
  { id: 'l9-22', front: 'Hur håller du paket på specifik version?', back: 'sudo apt-mark hold paketnamn\ndnf versionlock add', category: 'Version', difficulty: 'G' },
  // Hard (8)
  { id: 'l9-23', front: 'Hur lägger du till dnf repository?', back: 'dnf config-manager --add-repo URL\neller: skapa .repo-fil i /etc/yum.repos.d/', category: 'Repos', difficulty: 'VG' },
  { id: 'l9-24', front: 'Hur importerar du GPG-nyckel för repo?', back: 'apt-key add key.gpg (deprecated)\ngpg --dearmor > /usr/share/keyrings/', category: 'Säkerhet', difficulty: 'VG' },
  { id: 'l9-25', front: 'Hur bygger du paket från source?', back: './configure\nmake\nsudo make install', category: 'Source', difficulty: 'VG' },
  { id: 'l9-26', front: 'Hur nedgraderar du paket?', back: 'apt install paket=version\ndnf downgrade paket', category: 'Version', difficulty: 'VG' },
  { id: 'l9-27', front: 'Hur visar du paket-beroenden?', back: 'apt depends paketnamn\napt rdepends (reverse)', category: 'Info', difficulty: 'VG' },
  { id: 'l9-28', front: 'Hur fixar du trasiga beroenden?', back: 'sudo apt --fix-broken install\nsudo dpkg --configure -a', category: 'Fix', difficulty: 'VG' },
  { id: 'l9-29', front: 'Hur skapar du lokalt repository?', back: 'dpkg-scanpackages . | gzip > Packages.gz\ncreaterepo /path', category: 'Repos', difficulty: 'VG' },
  { id: 'l9-30', front: 'Vad är snap och flatpak?', back: 'Universal paketformat.\nContainerized, sandboxed apps.', category: 'Koncept', difficulty: 'VG' }
]
...
const TASK_12_FLASHCARDS: TaskFlashcard[] = [
  ...
  { id: 'l12f7', front: 'Hur skapar du zip-arkiv?', back: 'zip arkiv.zip filer\nzip -r arkiv.zip katalog/', category: 'zip', difficulty: 'G' },
  { id: 'l12f8', front: 'Hur extraherar du zip?', back: 'unzip arkiv.zip\nunzip arkiv.zip -d destination/', category: 'zip', difficulty: 'G' },
  { id: 'l12f9', front: 'Skillnad tar vs zip?', back: 'tar: arkiverar, komprimerar ej själv\nzip: arkiverar + komprimerar varje fil', category: 'Koncept', difficulty: 'G' },
  { id: 'l12f10', front: 'Hur behåller du original vid gzip?', back: 'gzip -k fil\n-k = keep original', category: 'gzip', difficulty: 'G' },
  // Medium (12)
  { id: 'l12f11', front: 'Hur använder du bzip2?', back: 'bzip2 fil → fil.bz2\nbunzip2 fil.bz2\nBättre kompression än gzip.', category: 'bzip2', difficulty: 'G' },
  { id: 'l12f12', front: 'Hur skapar du .tar.bz2?', back: 'tar -cjvf arkiv.tar.bz2 filer/\nj=bzip2', category: 'tar', difficulty: 'G' },
  { id: 'l12f13', front: 'Hur skapar du .tar.xz?', back: 'tar -cJvf arkiv.tar.xz filer/\nJ=xz (bäst kompression)', category: 'tar', difficulty: 'G' },
  { id: 'l12f14', front: 'Hur extraherar du till specifik katalog?', back: 'tar -xvf arkiv.tar -C /dest/\nunzip arkiv.zip -d /dest/', category: 'tar', difficulty: 'G' },
  { id: 'l12f15', front: 'Hur visar du innehåll i zip?', back: 'unzip -l arkiv.zip\nListar utan att extrahera.', category: 'zip', difficulty: 'G' },
  { id: 'l12f16', front: 'Hur komprimerar du med specifik nivå?', back: 'gzip -9 fil (max)\ngzip -1 fil (snabbast)', category: 'gzip', difficulty: 'G' },
  { id: 'l12f17', front: 'Hur lägger du till filer i tar?', back: 'tar -rvf arkiv.tar nyfil\nr=append', category: 'tar', difficulty: 'G' },
  { id: 'l12f18', front: 'Hur extraherar du specifik fil från tar?', back: 'tar -xvf arkiv.tar path/till/fil', category: 'tar', difficulty: 'G' },
  { id: 'l12f19', front: 'Hur skapar du lösenordsskyddad zip?', back: 'zip -e arkiv.zip filer', category: 'zip', difficulty: 'G' },
  { id: 'l12f20', front: 'Hur visar du kompressionsratio?', back: 'gzip -l fil.gz', category: 'Info', difficulty: 'G' },
  { id: 'l12f21', front: 'Hur komprimerar du med xz?', back: 'xz fil\nunxz fil.xz', category: 'xz', difficulty: 'G' },
  { id: 'l12f22', front: 'Hur använder du pigz (parallel gzip)?', back: 'pigz fil\nSnabbare på multi-core.', category: 'Parallell', difficulty: 'G' },
  // Hard (8)
  { id: 'l12f23', front: 'Hur skapar du inkrementell backup med tar?', back: 'tar --listed-incremental=snapshot.snar -cvzf backup.tar.gz /data', category: 'Backup', difficulty: 'VG' },
  { id: 'l12f24', front: 'Hur exkluderar du filer i tar?', back: 'tar --exclude="*.log" -cvzf arkiv.tar.gz /data', category: 'tar', difficulty: 'VG' },
  { id: 'l12f25', front: 'Hur streamar du tar över SSH?', back: 'tar czvf - /data | ssh user@host "cat > backup.tar.gz"', category: 'Remote', difficulty: 'VG' },
  { id: 'l12f26', front: 'Hur testar du arkivintegritet?', back: 'gzip -t fil.gz\ntar -tvf arkiv.tar', category: 'Verifiera', difficulty: 'VG' },
  { id: 'l12f27', front: 'Hur skapar du split arkiv?', back: 'split -b 100M arkiv.tar.gz arkiv.part.\ncat arkiv.part.* > arkiv.tar.gz', category: 'Split', difficulty: 'VG' },
  { id: 'l12f28', front: 'Vad är 7z och hur används det?', back: '7z a arkiv.7z filer\n7z x arkiv.7z\nHög kompression.', category: '7zip', difficulty: 'VG' },
  { id: 'l12f29', front: 'Hur bevarar du rättigheter i tar?', back: 'tar --preserve-permissions -cvzf arkiv.tar.gz /data\neller: tar -p', category: 'tar', difficulty: 'VG' },
  { id: 'l12f30', front: 'Hur skapar du tar med absolut sökväg?', back: 'tar -cvPf arkiv.tar /full/path\nP = preserve absolute path', category: 'tar', difficulty: 'VG' }
]
...
export function getFlashcardsByDifficulty(difficulty: 'G' | 'VG'): TaskFlashcard[] {
