...
const TASK_2_QUIZ: TaskQuizQuestion[] = [
    ...
    { id: 'l2q12', question: 'Hur söker du rekursivt med grep?', options: ['grep -r', 'grep -R', 'grep -d', 'Båda A och B fungerar'], correctIndex: 3, explanation: 'Både -r och -R fungerar för rekursiv sökning.', difficulty: 'G', category: 'grep' },
    // VG-nivå (8)
...
const TASK_5_QUIZ: TaskQuizQuestion[] = [
    ...
    { id: 'l5q10', question: 'Hur visar du loggar från nuvarande boot?', options: ['journalctl -b', 'journalctl --boot', 'journalctl -c', 'Båda A och B fungerar'], correctIndex: 3, explanation: '-b eller --boot visar loggar från current boot.', difficulty: 'G', category: 'journalctl' },
    ...
    { id: 'l5q20', question: 'Hur visar du kernel-loggar med journalctl?', options: ['journalctl -k', 'journalctl --kernel', 'journalctl -d', 'Båda A och B fungerar'], correctIndex: 3, explanation: '-k eller --kernel visar endast kernel-meddelanden.', difficulty: 'VG', category: 'journalctl' }
]
