...
const MOCK_MODULES: EnhancedModule[] = [
    ...
    // =========== HANDS-ON LAB - PRAKTISKA ÖVNINGAR ===========
    {
        id: "hands-on-lab",
        name: "Hands-On Lab",
        slug: "hands-on-lab",
        description: "Praktiska labbar för DevOps. Filsystem, SSH, brandvägg, användarhantering, subnetting, Docker och kryptering.",
        order_index: 1,
        orderIndex: 1,
        difficulty: "beginner",
        estimated_hours: 14,
        ...
        totalTasks: 7,
        status: "not_started",
        tags: ["Hands-On", "SSH", "Docker", "LVM", "LUKS"],
        xp: 2100,
    },
    // =========== BOOTCAMP MODULER ===========
    {
