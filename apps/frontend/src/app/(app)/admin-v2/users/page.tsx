...
export default function AdminV2Users() {
    ...
    const handleAction = (action: string, user: User) => {
        switch (action) {
            case "view":
                window.location.href = `/admin-v2/users/${user.id}`
                break
            ...
            case "ban":
                if (user.is_banned) {
                    setConfirmDialog({
                        ...
                        action: () => executeAction(action, `/api/admin-v2/users/${user.id}/unban`),
                    ...
                    setConfirmDialog({
                        ...
                        action: () => executeAction(action, `/api/admin-v2/users/${user.id}/ban`),
