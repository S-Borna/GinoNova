...
""",
    "quiz": [
        {
            "question": "Vilket är korrekt sätt att skapa en variabel i Bash?",
            "options": [
                "namn = \"Lisa\"",
                "namn=\"Lisa\"",
                "$namn=\"Lisa\"",
            ...
            "correct": 1,
            "explanation": "I Bash får det INTE finnas mellanslag runt =. Rätt syntax är namn=\"värde\"."
        },
        {
            "question": "Vad innehåller variabeln $# i ett skript?",
            "options": [
                "Skriptets namn",
                "Senaste exit code",
                "Antal argument som skickades till skriptet",
                "Skriptets process-ID"
            ],
            "correct": 2,
            "explanation": "$# innehåller antalet positionsargument. Om du kör ./skript.sh a b c är $# = 3."
        },
        {
            "question": "Vad skriver echo 'Hej $USER' ut?",
            "options": [
                "Hej [ditt användarnamn]",
                "Hej $USER",
                "Hej",
                "Felmeddelande"
            ],
            "correct": 1,
            "explanation": "Enkla citattecken ('...') expanderar INGENTING. Texten $USER skrivs ut bokstavligt."
        },
        {
            "question": "Vad skriver echo \"Hej $USER\" ut? (om USER=student)",
            "options": [
                "Hej student",
                "Hej $USER",
                "Hej",
            ...
            "correct": 0,
            "explanation": "Dubbla citattecken (\"...\") expanderar variabler. $USER ersätts med värdet 'student'."
        },
        {
            "question": "Hur fångar du resultatet av kommandot date i en variabel?",
            "options": [
                "datum=date",
                "datum=$(date)",
                "datum=$date",
            ...
            "correct": 1,
            "explanation": "$(kommando) är command substitution - den kör kommandot och returnerar resultatet."
        },
        {
            "question": "Vad gör kommandot export MIN_VAR=\"test\"?",
            "options": [
                "Skapar en lokal variabel som bara finns i skriptet",
                "Tar bort variabeln MIN_VAR",
                "Gör variabeln tillgänglig för subprocesser",
                "Skriver ut variabelns värde"
            ],
            "correct": 2,
            "explanation": "export gör att variabeln ärvs av alla child-processer som startas från skriptet."
        },
        {
            "question": "Vad genererar echo {a,b,c}.txt?",
            "options": [
                "abc.txt",
                "{a,b,c}.txt",
                "a.txt b.txt c.txt",
            ...
            "correct": 2,
            "explanation": "Brace expansion genererar alla kombinationer. {a,b,c}.txt blir a.txt b.txt c.txt."
        },
        {
            "question": "Vad returnerar ${namn:-Gäst} om variabeln $namn är tom?",
            "options": [
                "Tom sträng",
                "Gäst",
                "namn",
        ...
        {
            "question": "Vilken variabel innehåller exit code från senaste körda kommando?",
            "options": [
                "$!",
                "$#",
                "$?",
            ...
            "correct": 2,
            "explanation": "$? innehåller alltid exit code från det senast körda kommandot. 0 = OK, annat = fel."
        },
        {
            "question": "Varför ska du alltid använda \"$variabel\" med dubbla citattecken?",
            "options": [
                "Det ser mer professionellt ut",
                "Det skyddar mot problem med mellanslag i variabelns värde",
                "Det går snabbare att köra",
                "Variabeln blir permanent sparad"
            ],
            "correct": 1,
            "explanation": "Om variabeln innehåller mellanslag (t.ex. 'min fil.txt') tolkas den som flera argument utan citattecken."
        }
    ]
}
...
# =============================================================================
VARIABLER_QUOTING_FLASHCARDS = [
    {"front": "Skapa variabel i Bash?", "back": "namn=\"värde\" (inga mellanslag runt =)"},
    ...
    {"front": "$@ innehåller?", "back": "Alla argument (som separata ord)"},
    {"front": "$* innehåller?", "back": "Alla argument (som ett ord)"},
    {"front": "$? innehåller?", "back": "Exit code från senaste kommando"},
    {"front": "$$ innehåller?", "back": "Skriptets process-ID (PID)"},
    {"front": "\"dubbla citattecken\" gör?", "back": "Expanderar variabler, skyddar mellanslag"},
    {"front": "'enkla citattecken' gör?", "back": "INGENTING expanderas - bokstavlig text"},
    {"front": "Command substitution syntax?", "back": "$(kommando) eller `kommando`"},
    {"front": "Rekommenderad command substitution?", "back": "$(kommando) - modern och nästlingsbar"},
    {"front": "Fånga datum i variabel?", "back": "datum=$(date +%Y-%m-%d)"},
    {"front": "export VAR gör?", "back": "Gör variabeln tillgänglig för subprocesser"},
    {"front": "{1..5} genererar?", "back": "1 2 3 4 5"},
    {"front": "{a,b,c}.txt genererar?", "back": "a.txt b.txt c.txt"},
    {"front": "~ expanderar till?", "back": "Din hemkatalog (/home/user)"},
    {"front": "${var:-default} gör?", "back": "Returnerar default om var är tom"},
    {"front": "${#var} returnerar?", "back": "Längden på variabelns värde"},
    {"front": "Varför \"$var\" med citattecken?", "back": "Skyddar mot problem med mellanslag"},
]
