...
""",
    "quiz": [
        {
            "question": "Vad matchar regex-mönstret h.t?",
            "options": [
                "Bara exakt \"hat\"",
                "\"hat\", \"hot\", \"hit\", \"h9t\"",
                "\"ht\"",
            ...
            "correct": 1,
            "explanation": "Punkt (.) matchar exakt ETT valfritt tecken. Så h.t matchar h + valfritt tecken + t."
        },
        {
            "question": "Vad betyder * i regex?",
            "options": [
                "Ett eller fler av föregående",
                "Noll eller fler av föregående",
                "Exakt ett tecken",
                "Valfritt antal valfria tecken"
            ],
            "correct": 1,
            "explanation": "* betyder noll eller fler av föregående tecken/grupp. ab*c matchar ac, abc, abbc osv."
        },
        {
            "question": "Vad matchar ^Hej?",
            "options": [
                "Rader som innehåller \"Hej\" var som helst",
                "Rader som BÖRJAR med \"Hej\"",
                "Rader som slutar med \"Hej\"",
                "Bara ordet \"Hej\" ensamt"
            ],
            "correct": 1,
            "explanation": "^ (cirkumflex) betyder början av rad. ^Hej matchar rader som börjar med Hej."
        },
        {
            "question": "Vad matchar [^0-9]?",
            "options": [
                "Alla siffror 0-9",
                "Siffror i början av rad",
                "Allt UTOM siffror",
                "Ingenting"
            ],
            "correct": 2,
        ...
        {
            "question": "Vilken grep-flagga gör sökningen case-insensitive?",
            "options": [
                "-c",
                "-v",
                "-i",
            ...
            "correct": 2,
            "explanation": "-i (insensitive) ignorerar skillnad mellan VERSALER och gemener."
        },
        {
            "question": "Vad gör kommandot grep -v \"^#\" config.txt?",
            "options": [
                "Visar rader som börjar med #",
                "Visar rader som INTE börjar med #",
                "Räknar rader som börjar med #",
                "Tar bort # från alla rader"
            ],
            "correct": 1,
            "explanation": "-v inverterar matchningen. Visar alla rader som INTE matchar mönstret ^# (börjar med #)."
        },
        {
            "question": "Vad är skillnaden mellan BRE och ERE?",
            "options": [
                "Ingen skillnad alls",
                "BRE är snabbare",
                "I BRE måste + ? { } escapas med backslash",
                "ERE stödjer inte teckenklasser"
            ],
            "correct": 2,
            "explanation": "I BRE (Basic) måste + ? { } ( ) skrivas som \\+ \\? \\{ \\} \\( \\). I ERE fungerar de direkt."
        },
        {
            "question": "Hur aktiverar du Extended Regular Expressions i grep?",
            "options": [
                "grep -B",
                "grep -E",
                "grep -R",
            ...
            "correct": 1,
            "explanation": "grep -E aktiverar ERE (Extended Regular Expressions). Alternativt kan du använda egrep."
        },
        {
            "question": "Vad matchar [0-9]{3}?",
            "options": [
                "Siffran 3",
                "Tre valfria tecken",
                "Exakt tre siffror i rad",
                "Siffrorna 0, 1, 2 och 3"
            ],
            "correct": 2,
            "explanation": "{3} är en kvantifierare som betyder 'exakt 3 st'. [0-9]{3} matchar exakt tre siffror."
        },
        {
            "question": "Hur testar du om en variabel matchar ett regex i Bash?",
            "options": [
                "if [[ $var == regex ]]",
                "if [[ $var =~ regex ]]",
                "if [ $var ~ regex ]",
            ...
            "correct": 1,
            "explanation": "=~ är regex-operatorn i Bash. Används inom [[ ]] för mönstermatchning."
        }
    ]
}
...
# =============================================================================
REGEX_FLASHCARDS = [
    {"front": ". (punkt) i regex?", "back": "Matchar ETT valfritt tecken"},
    {"front": "* i regex?", "back": "Noll eller fler av föregående"},
    {"front": "+ i regex?", "back": "En eller fler av föregående"},
    {"front": "? i regex?", "back": "Noll eller en av föregående"},
    {"front": "^ i regex?", "back": "Början av rad"},
    {"front": "$ i regex?", "back": "Slutet av rad"},
    {"front": "[abc] matchar?", "back": "Ett av tecknen a, b eller c"},
    {"front": "[^abc] matchar?", "back": "Allt UTOM a, b, c"},
    {"front": "[0-9] matchar?", "back": "En siffra 0-9"},
    {"front": "[a-zA-Z] matchar?", "back": "En bokstav (stor eller liten)"},
    {"front": "grep -E?", "back": "Extended Regular Expressions (ERE)"},
    {"front": "grep -i?", "back": "Case insensitive sökning"},
    {"front": "grep -v?", "back": "Invertera - visa EJ matchande"},
    {"front": "grep -c?", "back": "Räkna antal matchningar"},
    {"front": "grep -n?", "back": "Visa radnummer"},
    {"front": "{n} i regex?", "back": "Exakt n förekomster"},
    {"front": "{n,m} i regex?", "back": "Mellan n och m förekomster"},
    {"front": "BRE vs ERE?", "back": "BRE kräver \\+ \\? \\{\\}, ERE behöver ej escape"},
    {"front": "Bash regex-test?", "back": "[[ $var =~ ^mönster$ ]]"},
    {"front": "Datum-regex YYYY-MM-DD?", "back": "^[0-9]{4}-[0-9]{2}-[0-9]{2}$"},
]
