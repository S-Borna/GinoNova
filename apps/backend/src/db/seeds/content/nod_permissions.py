    ...
    "quiz": [
        {
            ...
            "correct": 1,
            "explanation": "7=rwx för owner, 5=r-x för group, 5=r-x för others."
        },
        {
            "question": "Vad gör SGID på en katalog?",
            "options": [
                "Alla kan läsa katalogen",
                "Nya filer ärver katalogen gruppägande",
                "Endast root kan ändra",
                "Filerna blir osynliga"
            ],
            "correct": 1,
            "explanation": "SGID på katalog gör att nya filer automatiskt får samma grupp som katalogen."
        },
        {
            "question": "Hur ser du att SGID är aktivt?",
            "options": [
                "'d' i början",
                "'s' på group-positionen",
                "'t' på other-positionen",
                "'+' i slutet"
            ],
            "correct": 1,
            "explanation": "drwxrwsr-x - 's' på gruppens x-position visar SGID."
        },
        {
            "question": "Vad är korrekt kommando för delad katalog?",
            "options": [
                "chmod 777 /shared",
                "chmod 2770 /shared",
                "chmod 1755 /shared",
            ...
            "correct": 1,
            "explanation": "2770 = SGID (2) + rwxrwx--- (770). SGID gör att nya filer ärver gruppen."
        },
        {
            "question": "Vad gör sticky bit på /tmp?",
            "options": [
                "Gör katalogen osynlig",
                "Endast root kan läsa",
                "Användare kan bara ta bort sina egna filer",
                "Alla filer raderas automatiskt"
            ],
            "correct": 2,
            "explanation": "Sticky bit förhindrar att användare tar bort andras filer."
        },
        {
            "question": "Hur beräknas rw-r--r-- i oktal?",
            "options": [
                "755",
                "644",
                "700",
            ...
            "correct": 1,
            "explanation": "rw- = 6, r-- = 4, r-- = 4 → 644."
        },
        {
            "question": "Vad gör chmod u+s på en fil?",
            "options": [
                "Sätter sticky bit",
                "Sätter SUID",
                "Sätter SGID",
            ...
            "correct": 1,
            "explanation": "u+s sätter SUID (Set User ID) - filen körs som ägaren."
        },
        {
            "question": "Korrekt SSH-permission för ~/.ssh?",
            "options": [
                "777",
                "755",
                "700",
            ...
            "correct": 2,
            "explanation": "~/.ssh måste vara 700 (rwx------) för att SSH ska fungera."
        },
        {
            "question": "Vad betyder 't' i drwxrwxrwt?",
            "options": [
                "Temporary file",
                "Sticky bit är aktivt",
                "Transfer mode",
                "Trusted directory"
            ],
            "correct": 1,
            "explanation": "'t' på others x-position visar att sticky bit är satt."
        },
        {
            "question": "chown :developers fil ändrar?",
            "options": [
                "Endast ägare",
                "Endast grupp",
                "Både ägare och grupp",
                "Permissions"
            ],
            "correct": 1,
            "explanation": ":grupp utan användarnamn ändrar endast gruppägandet."
        }
    ]
}
...
# =============================================================================
PERMISSIONS_FLASHCARDS = [
    {"front": "chmod 755 ger?", "back": "rwxr-xr-x"},
    {"front": "chmod 644 ger?", "back": "rw-r--r--"},
    {"front": "chmod 700 ger?", "back": "rwx------"},
    {"front": "r+w+x i oktal?", "back": "4+2+1 = 7"},
    {"front": "r+x i oktal?", "back": "4+1 = 5"},
    {"front": "SUID gör (på fil)?", "back": "Filen körs som ägaren"},
    {"front": "SGID gör (på katalog)?", "back": "Nya filer ärver gruppägandet"},
    {"front": "Sticky bit gör?", "back": "Endast ägare kan ta bort sina filer"},
    {"front": "chmod 2775 betyder?", "back": "SGID + rwxrwxr-x"},
    {"front": "chmod 4755 betyder?", "back": "SUID + rwxr-xr-x"},
    {"front": "chmod 1777 betyder?", "back": "Sticky + rwxrwxrwx"},
    {"front": "'s' på group betyder?", "back": "SGID är aktivt"},
    {"front": "'t' på others betyder?", "back": "Sticky bit är aktivt"},
    {"front": "chown user:grupp fil gör?", "back": "Ändrar både ägare och grupp"},
    {"front": "chown :grupp fil gör?", "back": "Ändrar endast grupp"},
    {"front": "chmod -R gör?", "back": "Ändrar permissions rekursivt"},
    {"front": "Korrekta ~/.ssh permissions?", "back": "700 för katalog, 600 för nycklar"},
    {"front": "/tmp har vilken special perm?", "back": "Sticky bit (1777)"},
    {"front": "chmod u+x gör?", "back": "Lägger till execute för owner"},
    {"front": "chmod a+r gör?", "back": "Lägger till read för alla"},
]
