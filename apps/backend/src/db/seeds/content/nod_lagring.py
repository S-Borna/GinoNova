...
""",
    "quiz": [
        {
            "question": "Rätt ordning för disk setup?",
            "options": [
                "Filsystem → Partition → Mount",
                "Partition → Filsystem → Mount",
                "Mount → Partition → Filsystem",
                "Filsystem → Mount → Partition"
            ],
            "correct": 1,
            "explanation": "Partition först, sedan filsystem, sist montering."
        },
        {
            "question": "Vad visar lsblk?",
            "options": [
                "Bara monterade diskar",
                "Alla block devices",
                "Bara partitioner",
                "Bara LUKS-volymer"
            ],
            "correct": 1,
            "explanation": "lsblk listar alla block devices - diskar och partitioner."
        },
        {
            "question": "Hur skapar du en partition i fdisk?",
            "options": [
                "c",
                "p",
                "n",
            ...
            "correct": 2,
            "explanation": "n = new partition. p = print, w = write."
        },
        {
            "question": "Hur sparar du ändringar i fdisk?",
            "options": [
                "s",
                "q",
                "w",
            ...
            "correct": 2,
            "explanation": "w = write. q = quit utan att spara."
        },
        {
            "question": "Vad gör cryptsetup luksFormat?",
            "options": [
                "Formaterar till ext4",
                "Krypterar partitionen",
                "Monterar disk",
                "Öppnar krypterad volym"
            ],
            "correct": 1,
            "explanation": "luksFormat skapar kryptering. VARNING: Raderar all data!"
        },
        {
            ...
            "correct": 1,
            "explanation": "Öppnade LUKS-volymer skapas under /dev/mapper/."
        },
        {
            ...
            "correct": 1,
            "explanation": "luksClose låser/stänger den öppnade volymen."
        },
        {
            "question": "Vilket kommando skapar ext4-filsystem?",
            "options": [
                "format ext4",
                "mkfs.ext4",
                "mkext4",
            ...
            "correct": 1,
            "explanation": "mkfs.ext4 = make filesystem ext4."
        },
        {
            "question": "Var konfigureras permanent montering?",
            "options": [
                "/etc/mount",
                "/etc/fstab",
                "/etc/disk",
            ...
            "correct": 1,
            "explanation": "fstab = filesystem table, konfigurerar automatisk montering."
        },
        {
            "question": "Hur testar du fstab utan omstart?",
            "options": [
                "fstab --test",
                "mount -a",
                "mount --test",
            ...
            "correct": 1,
            "explanation": "mount -a monterar allt i fstab, upptäcker fel direkt."
        }
    ]
}
...
# =============================================================================
LAGRING_FLASHCARDS = [
    {"front": "lsblk visar?", "back": "Lista block devices (diskar/partitioner)"},
    {"front": "fdisk /dev/sdb gör?", "back": "Startar partitioneringsverktyget"},
    {"front": "fdisk: n gör?", "back": "Skapar ny partition"},
    {"front": "fdisk: w gör?", "back": "Skriver ändringar och avslutar"},
    {"front": "fdisk: p gör?", "back": "Visar (print) partitioner"},
    {"front": "fdisk: q gör?", "back": "Avslutar utan att spara"},
    {"front": "cryptsetup luksFormat gör?", "back": "Krypterar partition (raderar data!)"},
    {"front": "cryptsetup luksOpen gör?", "back": "Dekrypterar och öppnar volymen"},
    {"front": "cryptsetup luksClose gör?", "back": "Stänger/låser krypterad volym"},
    {"front": "Var hamnar öppnad LUKS?", "back": "/dev/mapper/namn"},
    {"front": "mkfs.ext4 gör?", "back": "Skapar ext4-filsystem"},
    {"front": "mount /dev/sdb1 /mnt/data gör?", "back": "Monterar partition till katalog"},
    {"front": "umount gör?", "back": "Avmonterar filsystem"},
    {"front": "/etc/fstab används för?", "back": "Automatisk montering vid boot"},
    {"front": "blkid visar?", "back": "UUID för alla enheter"},
    {"front": "mount -a gör?", "back": "Monterar allt i fstab (test!)"},
    {"front": "Ordning: Disk setup?", "back": "Partition → Filsystem → Mount"},
    {"front": "lsblk -f visar extra?", "back": "Filsystemtyp och UUID"},
    {"front": "Kursens analogi: Partition?", "back": "Betongen (grunden)"},
    {"front": "Kursens analogi: Filsystem?", "back": "Möblerna (organisationen)"},
]
