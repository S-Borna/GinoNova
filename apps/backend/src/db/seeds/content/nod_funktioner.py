...
""",
    "quiz": [
        {
            "question": "Vilken syntax skapar en funktion korrekt?",
            "options": [
                "function hälsa[] { echo \"Hej\"; }",
                "hälsa() { echo \"Hej\"; }",
                "def hälsa() { echo \"Hej\"; }",
                "hälsa = function() { echo \"Hej\"; }"
            ],
            "correct": 1,
            "explanation": "I Bash skapar man funktioner med namn() { kommandon; } eller function namn { }."
        },
        {
            ...
            "correct": 2,
            "explanation": "Funktioner använder samma parametersystem som skript: $1, $2, $3 osv."
        },
        {
            "question": "Vad är max returvärde med return?",
            "options": [
                "100",
                "255",
                "999",
            ...
            "correct": 1,
            "explanation": "return kan endast returnera 0-255 (exit status). Större värden wrappas med modulo 256."
        },
        {
            "question": "Hur returnerar du en textsträng från en funktion?",
            "options": [
                "return \"text\"",
                "echo \"text\"",
                "yield \"text\"",
            ...
            "correct": 1,
            "explanation": "return tar bara nummer. Använd echo för att 'returnera' text, fånga med $(func)."
        },
        {
            "question": "Vad gör local i en funktion?",
            "options": [
                "Gör funktionen privat",
                "Gör variabeln endast tillgänglig i funktionen",
                "Låser variabeln mot ändringar",
                "Exporterar variabeln till miljön"
            ],
            "correct": 1,
            "explanation": "local begränsar variabelns scope till funktionen. Utan local blir den global."
        },
        {
            "question": "Hur fångar du output från en funktion?",
            "options": [
                "var = funktionsnamn",
                "var=$(funktionsnamn)",
                "funktionsnamn > var",
            ...
            "correct": 1,
            "explanation": "Command substitution $(funktionsnamn) fångar det funktionen skriver till stdout."
        },
        {
            "question": "Vad returnerar en funktion om inget return anges?",
            "options": [
                "Alltid 0",
                "Alltid 1",
                "Exit status från sista kommandot",
                "Undefined"
            ],
            "correct": 2,
            "explanation": "Utan explicit return blir returvärdet exit status från sista körda kommandot."
        },
        {
            ...
            "options": [
                "I början av filen",
                "Före första anropet",
                "Efter alla variabler",
                "Spelar ingen roll"
            ],
            "correct": 1,
            "explanation": "Bash läser sekventiellt. Funktionen måste definieras innan den anropas."
        },
        {
            "question": "Vad händer om du kör return 300?",
            "options": [
                "Returnerar 300",
                "Ger syntax error",
                "Returnerar 44 (300 mod 256)",
                "Returnerar 255"
            ],
            "correct": 2,
            "explanation": "Exit status är 8-bit (0-255). 300 mod 256 = 44."
        },
        {
            "question": "Hur kontrollerar du om en funktion lyckades?",
            "options": [
                "if [[ funktionsnamn ]]; then",
                "if funktionsnamn; then",
                "if result = funktionsnamn; then",
                "try funktionsnamn; catch"
            ],
            "correct": 1,
            "explanation": "if funktionsnamn; then kör funktionen och kollar dess returvärde (0 = sant)."
        }
    ]
}
...
# =============================================================================
FUNKTIONER_FLASHCARDS = [
    {"front": "Skapa funktion?", "back": "namn() { kommandon; }"},
    {"front": "Alternativ syntax?", "back": "function namn { }"},
    {"front": "Första argumentet?", "back": "$1"},
    {"front": "Alla argument?", "back": "$@ eller $*"},
    {"front": "Antal argument?", "back": "$#"},
    {"front": "return gör?", "back": "Avslutar funktion med status 0-255"},
    {"front": "exit gör?", "back": "Avslutar HELA skriptet"},
    {"front": "Returnera text?", "back": "echo \"text\""},
    {"front": "Fånga output?", "back": "var=$(funktionsnamn)"},
    {"front": "Lokal variabel?", "back": "local var=\"värde\""},
    {"front": "Varför local?", "back": "Undviker att ändra globala variabler"},
    {"front": "return utan värde?", "back": "Returnerar status från sista kommandot"},
    {"front": "Max return-värde?", "back": "255 (8-bit)"},
    {"front": "Kräv argument?", "back": "local arg=\"${1:?Error msg}\""},
    {"front": "Funktion med default?", "back": "local val=\"${1:-default}\""},
    {"front": "Kolla om lyckades?", "back": "if funktionsnamn; then"},
    {"front": "Fel: return 300?", "back": "Blir 44 (300 mod 256)"},
    {"front": "Anropa funktion?", "back": "funktionsnamn arg1 arg2"},
    {"front": "Rekursion möjlig?", "back": "Ja, funktion kan anropa sig själv"},
    {"front": "Lokal array?", "back": "local -a arr=(a b c)"},
]
