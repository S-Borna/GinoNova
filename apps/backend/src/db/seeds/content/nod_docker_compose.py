    ...
    "quiz": [
        {
            ...
            "options": [
                "En container",
                "Verktyg för multi-container applikationer",
                "Ett operativsystem",
                "En image"
            ],
            "correct": 1,
            "explanation": "Docker Compose definierar och kör multi-container applikationer via YAML-fil."
        },
        {
            "question": "Vilken fil beskriver Compose-stacken?",
            "options": [
                "Dockerfile",
                "compose.json",
                "docker-compose.yml",
            ...
            "correct": 2,
            "explanation": "docker-compose.yml (eller compose.yml) beskriver alla services."
        },
        {
            "question": "Hur startar du alla services i bakgrunden?",
            "options": [
            ...
            "correct": 1,
            "explanation": "up startar stacken, -d kör i bakgrunden (detached)."
        },
        {
            ...
            "options": [
                "Bara stoppar",
                "Tar bort containers",
                "Tar bort allt inkl volumes",
                "Visar version"
            ],
            "correct": 2,
            "explanation": "-v tar även bort named volumes - ALL data försvinner!"
        },
        {
            "question": "Hur refererar services till varandra i nätverk?",
            "options": [
                "Via IP-adress",
                "Via container-ID",
                "Via service-namn som hostname",
            ...
            "correct": 2,
            "explanation": "Service-namn fungerar som hostname (db:5432, api:3000)."
        },
        {
            "question": "Var ska secrets som passwords lagras?",
            "options": [
                "I docker-compose.yml",
                "I .env-fil (gitignored)",
                "I Dockerfile",
                "Hårdkodade"
            ],
            "correct": 1,
            "explanation": ".env-filen ska ALDRIG committas - lägg den i .gitignore!"
        },
        {
            "question": "Vad gör depends_on?",
            "options": [
                "Installerar dependencies",
                "Kontrollerar startordning",
                "Väntar på att tjänst är redo",
                "Linkar containers"
            ],
            "correct": 1,
            "explanation": "depends_on styr ordning, men väntar INTE på att tjänsten är redo."
        },
        {
            "question": "Hur kör du kommando i körande service?",
            "options": [
                "docker compose run",
                "docker compose exec",
                "docker compose cmd",
            ...
            "correct": 1,
            "explanation": "exec kör kommando i KÖRANDE container (run skapar ny)."
        },
        {
            "question": "Skillnad mellan named volume och bind mount?",
            "options": [
                "Ingen skillnad",
                "Named = Docker hanterar, Bind = lokal path",
                "Bind är snabbare",
                "Named är temporärt"
            ],
            "correct": 1,
            "explanation": "Named volumes (data:/path) hanteras av Docker, bind mounts (./local:/path) pekar på lokala filer."
        },
        {
            "question": "docker compose up --build gör?",
            "options": [
                "Bara bygger",
                "Bygger images OCH startar",
                "Bygger utan cache",
                "Visar build-log"
            ],
            "correct": 1,
            "explanation": "--build bygger om images innan start - bra efter Dockerfile-ändringar."
        }
    ]
}
...
# =============================================================================
DOCKER_COMPOSE_FLASHCARDS = [
    {"front": "docker compose up -d gör?", "back": "Startar alla services i bakgrunden"},
    {"front": "docker compose down -v gör?", "back": "Stoppar och tar bort ALLT inkl volumes"},
    {"front": "depends_on gör?", "back": "Kontrollerar startordning (ej readiness)"},
    {"front": "Named volume syntax?", "back": "db_data:/var/lib/data"},
    {"front": "Bind mount syntax?", "back": "./local:/container/path"},
    {"front": "${VAR} i compose läser från?", "back": ".env-fil"},
    {"front": "docker compose logs -f gör?", "back": "Följer loggar i realtid"},
    {"front": "docker compose exec web bash?", "back": "Öppnar shell i web-service"},
    {"front": "Hur når services varandra?", "back": "Via service-namn som hostname"},
    {"front": "docker compose ps visar?", "back": "Status för alla services"},
    {"front": "docker compose up --build gör?", "back": "Bygger images OCH startar"},
    {"front": "volumes: sektion för?", "back": "Deklarera named volumes"},
    {"front": "restart: unless-stopped?", "back": "Startar om utom vid manuellt stopp"},
    {"front": "Var ska .env ALDRIG vara?", "back": "I Git (lägg i .gitignore)"},
    {"front": "docker compose exec vs run?", "back": "exec = körande, run = ny container"},
    {"front": "ports: '8080:80' betyder?", "back": "Host 8080 → Container 80"},
    {"front": "docker compose --scale web=3?", "back": "Kör 3 instanser av web"},
    {"front": ":ro i volume mount?", "back": "Read-only mount"},
    {"front": "WORDPRESS_DB_HOST: db?", "back": "Använder service-namn som hostname"},
    {"front": "docker compose down vs stop?", "back": "down tar bort, stop bara stoppar"},
]
