    ...
    "quiz": [
        {
            ...
            "correct": 1,
            "explanation": "Ctrl+C skickar SIGINT (interrupt, signal 2) till förgrundprocessen."
        },
        {
            ...
            "correct": 2,
            "explanation": "SIGKILL (9) och SIGSTOP (19) kan aldrig fångas eller ignoreras."
        },
        {
            "question": "Vad gör trap 'rm -f /tmp/file' EXIT?",
            "options": [
                "Tar bort filen omedelbart",
                "Tar bort filen när skriptet avslutas",
                "Ignorerar EXIT-signalen",
                "Skapar filen vid avslut"
            ],
            "correct": 1,
            "explanation": "trap ... EXIT kör kommandot när skriptet avslutas, oavsett hur det avslutas."
        },
        {
            "question": "Hur startar du en process i bakgrunden?",
            "options": [
                "bg kommando",
                "kommando &bg",
                "kommando &",
        ...
        },
        {
            ...
            "options": [
                "Avslutar processen",
                "Pausar processen (SIGSTOP)",
                "Kör processen i bakgrunden",
                "Skickar SIGKILL"
            ],
            "correct": 1,
            "explanation": "Ctrl+Z skickar SIGSTOP som pausar processen. Den kan återupptas med fg eller bg."
        },
        {
            "question": "Hur får du PID för senast startade bakgrundsprocess?",
            "options": [
                "$PID",
                "$!",
                "$$",
            ...
            "correct": 1,
            "explanation": "$! innehåller PID för senaste bakgrundsprocess. $$ är aktuellt shell, $? är exit status."
        },
        {
            "question": "Vad är skillnaden mellan SIGTERM och SIGKILL?",
            "options": [
                "Ingen skillnad",
                "SIGTERM kan fångas, SIGKILL kan inte",
                "SIGKILL är snällare",
                "SIGTERM fungerar bara för root"
            ],
            "correct": 1,
            "explanation": "SIGTERM (15) är en snäll förfrågan som kan fångas för cleanup. SIGKILL (9) tvingar avslut omedelbart."
        },
        {
            "question": "Hur väntar du på en bakgrundsprocess?",
            "options": [
                "sleep PID",
                "wait PID",
                "pause PID",
            ...
            "correct": 1,
            "explanation": "wait PID väntar tills processen avslutas och returnerar dess exit status."
        },
        {
            "question": "Vad gör kommandot fg %2?",
            "options": [
                "Startar jobb nummer 2",
                "Pausar jobb nummer 2",
                "Tar jobb nummer 2 till förgrunden",
                "Avslutar jobb nummer 2"
            ],
            "correct": 2,
            "explanation": "fg (foreground) tar ett bakgrundsjobb till förgrunden. %2 refererar till jobb nummer 2."
        },
        {
            "question": "Hur skickar du SIGTERM till process 1234?",
            "options": [
                "signal 1234",
                "kill 1234",
                "term 1234",
            ...
            "correct": 1,
            "explanation": "kill utan flagga skickar SIGTERM (15) som standard."
        }
    ]
}
...
# =============================================================================
SIGNALS_TRAPS_FLASHCARDS = [
    {"front": "SIGINT (2) - vad?", "back": "Interrupt - Ctrl+C"},
    {"front": "SIGTERM (15) - vad?", "back": "Terminate - snäll shutdown"},
    {"front": "SIGKILL (9) - vad?", "back": "Kill - tvångsavslut, kan EJ fångas"},
    {"front": "SIGHUP (1) - vad?", "back": "Hangup - terminal stängs"},
    {"front": "Vilka signaler kan ej fångas?", "back": "SIGKILL (9) och SIGSTOP (19)"},
    {"front": "kill PID skickar?", "back": "SIGTERM (15) som default"},
    {"front": "kill -9 PID gör?", "back": "Tvångsavslut med SIGKILL"},
    {"front": "trap syntax?", "back": "trap 'kommandon' SIGNAL"},
    {"front": "trap ... EXIT gör?", "back": "Kör kommandon vid skriptavslut"},
    {"front": "Ctrl+Z gör?", "back": "Pausar process (SIGSTOP)"},
    {"front": "bg gör?", "back": "Fortsätter pausad process i bakgrund"},
    {"front": "fg gör?", "back": "Tar bakgrundsprocess till förgrund"},
    {"front": "kommando & gör?", "back": "Kör kommando i bakgrunden"},
    {"front": "$! innehåller?", "back": "PID för senaste bakgrundsprocess"},
    {"front": "jobs gör?", "back": "Listar bakgrundsjobb"},
    {"front": "wait PID gör?", "back": "Väntar på process"},
    {"front": "nohup gör?", "back": "Ignorerar SIGHUP (överlever logout)"},
    {"front": "disown gör?", "back": "Kopplar loss process från shell"},
    {"front": "pkill namn gör?", "back": "Skickar signal till processer med namn"},
    {"front": "Cleanup-mönster?", "back": "trap 'rm -f $TMPFILE' EXIT"},
]
