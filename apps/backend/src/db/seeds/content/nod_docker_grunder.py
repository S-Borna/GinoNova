    ...
    "quiz": [
        {
            ...
            "options": [
                "Hela operativsystemet",
                "Kernel",
                "Ingenting",
                "Bara filsystemet"
            ],
            "correct": 1,
            "explanation": "Containers delar kernel med host - det är därför de är så lätta och snabba jämfört med VM."
        },
        {
            ...
            "correct": 1,
            "explanation": "-d = detached, containern körs i bakgrunden."
        },
        {
            "question": "Vad gör docker run --rm?",
            "options": [
                "Tar bort image efter körning",
                "Startar om automatiskt",
                "Tar bort container efter avslut",
                "Kör som root"
            ],
            "correct": 2,
            "explanation": "--rm tar automatiskt bort containern när den avslutas."
        },
        {
            "question": "Hur visar du ALLA containers (även stoppade)?",
            "options": [
                "docker ps --all",
                "docker ps -a",
                "docker list",
            ...
            "correct": 1,
            "explanation": "-a (all) visar alla containers, inte bara körande."
        },
        {
            ...
            "correct": 1,
            "explanation": "exec kör ett kommando inuti en redan körande container."
        },
        {
            "question": "Hur lägger du användare i docker-gruppen?",
            "options": [
                "docker adduser",
            ...
            "correct": 2,
            "explanation": "usermod -aG lägger till användare i en grupp (-a = append, -G = group)."
        },
        {
            "question": "Vilken flagga ger interaktiv terminal?",
            "options": [
                "-t",
                "-i",
                "-it",
            ...
            "correct": 2,
            "explanation": "-it kombinerar -i (interactive) och -t (tty/terminal)."
        },
        {
            "question": "Container vs VM - vilken startar snabbast?",
            "options": [
                "VM (har eget OS)",
                "Container (delar kernel)",
                "Samma hastighet",
                "Beror på image"
            ],
            "correct": 1,
            "explanation": "Containers startar på sekunder eftersom de delar kernel med host."
        },
        {
            "question": "Vad gör docker system prune -a?",
            "options": [
                "Bara stoppade containers",
                "Allt oanvänt inkl images",
                "Bara images",
                "Bara volymer"
            ],
            "correct": 1,
            "explanation": "-a tar bort ALLT oanvänt, inklusive images som inte används."
        },
        {
            "question": "Varför krävs docker-gruppen för att köra utan sudo?",
            "options": [
                "Docker kräver root",
                "Gruppen har access till Docker socket",
                "Det är en bugg",
                "Det krävs inte"
            ],
            "correct": 1,
            "explanation": "Docker daemon lyssnar på en Unix socket - docker-gruppen har rättigheter till den."
        }
    ]
}
...
# =============================================================================
DOCKER_GRUNDER_FLASHCARDS = [
    {"front": "Vad delar containers med host?", "back": "Kernel"},
    {"front": "docker run -d gör?", "back": "Kör i bakgrunden (detached)"},
    {"front": "docker run -it gör?", "back": "Interaktiv terminal"},
    {"front": "docker run --rm gör?", "back": "Tar bort containern efter avslut"},
    {"front": "docker ps visar?", "back": "Körande containers"},
    {"front": "docker ps -a visar?", "back": "ALLA containers (även stoppade)"},
    {"front": "docker rm -f gör?", "back": "Tvingar bort även körande container"},
    {"front": "Köra Docker utan sudo?", "back": "usermod -aG docker $USER"},
    {"front": "docker container prune gör?", "back": "Tar bort alla stoppade containers"},
    {"front": "Container vs VM storlek?", "back": "MB vs GB"},
    {"front": "Container vs VM starttid?", "back": "Sekunder vs minuter"},
    {"front": "docker exec -it container bash gör?", "back": "Öppnar shell i körande container"},
    {"front": "docker stop gör?", "back": "Stoppar körande container"},
    {"front": "docker start gör?", "back": "Startar stoppad container"},
    {"front": "-p 8080:80 betyder?", "back": "Host port 8080 → Container port 80"},
    {"front": "docker logs -f gör?", "back": "Följer loggar i realtid"},
    {"front": "docker system prune -a gör?", "back": "Tar bort ALLT oanvänt inkl images"},
    {"front": "Vad gör Docker daemon?", "back": "Hanterar containers och images"},
    {"front": "Var lagras images?", "back": "Docker Registry (Hub)"},
    {"front": "Hello World image storlek?", "back": "25 KB"},
]
