...
""",
    "quiz": [
        {
            "question": "Vilken nyckeltyp rekommenderas för SSH?",
            "options": [
                "rsa",
                "dsa",
                "ed25519",
        ...
        {
            "question": "Var lagras publika nycklar på servern?",
            "options": [
                "/etc/ssh/keys",
                "~/.ssh/authorized_keys",
                "~/.ssh/id_ed25519.pub",
            ...
            "correct": 1,
            "explanation": "authorized_keys i användarens ~/.ssh/ innehåller tillåtna publika nycklar."
        },
        {
            "question": "Vad gör PasswordAuthentication no?",
            "options": [
                "Låser alla konton",
                "Endast nyckelautentisering tillåts",
                "Tar bort alla lösenord",
                "Krypterar lösenord starkare"
            ],
            "correct": 1,
            "explanation": "Stänger av lösenordsinloggning helt - endast SSH-nycklar fungerar."
        },
        {
            "question": "I vilken ordning ska du härda SSH?",
            "options": [
                "Stäng lösenord → kopiera nyckel → testa",
                "Kopiera nyckel → testa → stäng lösenord",
                "Stäng lösenord → byt port → kopiera nyckel",
                "Ordningen spelar ingen roll"
            ],
            "correct": 1,
            "explanation": "ALLTID säkerställ att nycklar fungerar innan du stänger av lösenord!"
        },
        {
            "question": "Vad är SSH:s default port?",
            "options": [
                "21",
                "22",
                "80",
        ...
        },
        {
            ...
            "options": [
                "Kopierar privat nyckel till server",
                "Kopierar publik nyckel till authorized_keys",
                "Kopierar SSH-config",
                "Skapar en ny nyckel"
            ],
            "correct": 1,
        ...
        {
            "question": "Hur ansluter du till SSH på port 6622?",
            "options": [
                "ssh user@server:6622",
                "ssh -p 6622 user@server",
                "ssh --port 6622 user@server",
                "ssh user@server -port 6622"
            ],
            "correct": 1,
            "explanation": "-p flaggan anger port i SSH."
        },
        {
            ...
            "correct": 2,
            "explanation": "~/.ssh måste vara 700 (rwx------) för att SSH ska acceptera den."
        },
        {
            "question": "Vilket kommando startar om SSH-tjänsten på Ubuntu?",
            "options": [
                "sudo restart ssh",
                "sudo systemctl restart ssh",
            ...
            "correct": 1,
            "explanation": "systemctl restart ssh startar om SSH-demonen på systemd-system."
        },
        {
            "question": "Vad händer om du stänger PasswordAuthentication utan fungerande nyckel?",
            "options": [
                "SSH går till backup-läge",
                "Du låses ut från servern",
                "Lösenord fungerar ändå",
                "Servern startar om automatiskt"
            ],
            "correct": 1,
            "explanation": "Utan fungerande nyckel och med lösenord avstängt - ingen kan logga in!"
        }
    ]
}
...
# =============================================================================
SSH_HARDENING_FLASHCARDS = [
    {"front": "ssh-keygen -t ed25519 gör?", "back": "Genererar ed25519-nyckelpar"},
    {"front": "ssh-copy-id gör?", "back": "Kopierar publik nyckel till serverns authorized_keys"},
    {"front": "PasswordAuthentication no gör?", "back": "Stänger av lösenordsinloggning"},
    {"front": "PermitRootLogin no gör?", "back": "Förbjuder root att logga in via SSH"},
    {"front": "~/.ssh/authorized_keys innehåller?", "back": "Publika nycklar som får logga in"},
    {"front": "Default SSH-port?", "back": "22"},
    {"front": "Privat nyckel heter?", "back": "id_ed25519 (eller id_rsa)"},
    {"front": "Publik nyckel heter?", "back": "id_ed25519.pub"},
    {"front": "sudo systemctl restart ssh gör?", "back": "Startar om SSH-tjänsten"},
    {"front": "ssh -p 6622 gör?", "back": "Ansluter via port 6622"},
    {"front": "Permissions för ~/.ssh?", "back": "700 (rwx------)"},
    {"front": "Permissions för privat nyckel?", "back": "600 (rw-------)"},
    {"front": "AllowUsers said gör?", "back": "Endast said får SSH:a"},
    {"front": "Härdningsfil placeras var?", "back": "/etc/ssh/sshd_config.d/"},
    {"front": "Viktigaste härdningsregeln?", "back": "TESTA nycklar FÖRE du stänger lösenord!"},
    {"front": "ssh -v gör?", "back": "Verbose mode för debugging"},
    {"front": "Vad är ed25519?", "back": "Modern, säker SSH-nyckeltyp"},
    {"front": "Vilken nyckel delas aldrig?", "back": "Privata nyckeln (id_ed25519)"},
    {"front": "ss -tulpn | grep ssh visar?", "back": "Vilken port SSH lyssnar på"},
    {"front": "~/.ssh/config är för?", "back": "SSH-alias och anslutningsinställningar"},
]
