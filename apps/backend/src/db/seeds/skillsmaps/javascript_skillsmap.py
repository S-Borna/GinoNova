"""
JavaScript SkillsMap — Modern JavaScript for DevOps & Full-Stack
================================================================
...
Block 3 (Nodes 7-9): Data Structures
Block 4 (Nodes 10-12): Modern ES6+
Block 5 (Nodes 13-15): Asynchronous JS
Block 6 (Nodes 16-18): Advanced Patterns
Block 7 (Nodes 19-20): APIs & Capstone
"""

from typing import Any

# ============================================================================
# BLOCK 1: JAVASCRIPT BASICS (Nodes 1-3)
# ============================================================================

JS_NODE_01_INTRODUCTION = {
    "id": "js-01-introduction",
    "title": "JavaScript Introduction & Setup",
    "description": "Understand JavaScript's role and set up your development environment",
    "content": """
...
""",
    ...
    "difficulty": "beginner",
    "order_index": 1,
    "tags": ["javascript", "nodejs", "setup", "npm", "fundamentals"],
}

JS_NODE_02_VARIABLES = {
    "id": "js-02-variables",
...
""",
    ...
    "difficulty": "beginner",
    "order_index": 2,
    "tags": ["javascript", "variables", "types", "const", "let"],
}

JS_NODE_03_OPERATORS = {
    "id": "js-03-operators",
    "title": "Operators & Expressions",
    "description": "Master arithmetic, comparison, logical, and modern operators",
    "content": """
...
""",
    ...
    "difficulty": "beginner",
    "order_index": 3,
    "tags": ["javascript", "operators", "expressions", "comparison", "logical"],
}


# ============================================================================
# BLOCK 2: CONTROL FLOW (Nodes 4-6)
# ============================================================================

JS_NODE_04_CONDITIONALS = {
    "id": "js-04-conditionals",
...
""",
    ...
    "difficulty": "beginner",
    "order_index": 4,
    "tags": ["javascript", "conditionals", "if", "switch", "control-flow"],
}

JS_NODE_05_LOOPS = {
    "id": "js-05-loops",
    "title": "Loops — Iteration Patterns",
    "description": "Master for, while, and modern iteration methods",
    "content": """
...
""",
    ...
    "order_index": 5,
    "tags": ["javascript", "loops", "iteration", "arrays", "functional"],
}

JS_NODE_06_FUNCTIONS = {
    "id": "js-06-functions",
    "title": "Functions — Declaration to Arrow",
    "description": "Master all function forms and patterns in JavaScript",
    "content": """
...
""",
    ...
    "difficulty": "intermediate",
    "order_index": 6,
    "tags": ["javascript", "functions", "arrow", "closures", "higher-order"],
}


# ============================================================================
# BLOCK 3: DATA STRUCTURES (Nodes 7-9)
# ============================================================================

JS_NODE_07_ARRAYS = {
    "id": "js-07-arrays",
    "title": "Arrays — The Swiss Army Knife",
    "description": "Master array creation, manipulation, and methods",
    "content": """
...
""",
    ...
    "difficulty": "intermediate",
    "order_index": 7,
    "tags": ["javascript", "arrays", "methods", "data-structures"],
}

JS_NODE_08_OBJECTS = {
    "id": "js-08-objects",
    "title": "Objects — Key-Value Mastery",
    "description": "Master object creation, manipulation, and patterns",
    "content": """
...
""",
    ...
    "difficulty": "intermediate",
    "order_index": 8,
    "tags": ["javascript", "objects", "key-value", "data-structures"],
}

JS_NODE_09_DESTRUCTURING = {
    "id": "js-09-destructuring",
    "title": "Destructuring & Spread",
    "description": "Extract values elegantly and compose data structures",
    "content": """
...
""",
    ...
    "difficulty": "intermediate",
    "order_index": 9,
    "tags": ["javascript", "destructuring", "spread", "rest", "es6"],
}


# ============================================================================
# BLOCK 4: MODERN ES6+ (Nodes 10-12)
# ============================================================================

JS_NODE_10_ES6_FEATURES = {
    "id": "js-10-es6-features",
    "title": "ES6+ Modern Features",
    "description": "Master template literals, symbols, iterators, and more",
    "content": """
# ES6+ Modern Features
...
""",
    ...
    "difficulty": "intermediate",
    "order_index": 10,
    "tags": ["javascript", "es6", "map", "set", "generators", "modern"],
}

JS_NODE_11_CLASSES = {
    "id": "js-11-classes",
    "title": "Classes — OOP in JavaScript",
    "description": "Master class syntax, inheritance, and patterns",
    "content": """
...
JS_NODE_12_MODULES = {
    ...
    "description": "Organize code with ES modules and understand module systems",
    "content": """
...
""",
    ...
    "difficulty": "intermediate",
    "order_index": 12,
    "tags": ["javascript", "modules", "import", "export", "es6"],
}


# ============================================================================
# BLOCK 5: ASYNCHRONOUS JAVASCRIPT (Nodes 13-15)
# ============================================================================

JS_NODE_13_CALLBACKS = {
    "id": "js-13-callbacks",
    "title": "Callbacks & the Event Loop",
    "description": "Understand async fundamentals and JavaScript's concurrency model",
    "content": """
...
""",
    ...
    "difficulty": "intermediate",
    "order_index": 13,
    "tags": ["javascript", "callbacks", "event-loop", "async", "fundamentals"],
}

JS_NODE_14_PROMISES = {
    "id": "js-14-promises",
    "title": "Promises — Better Async",
    "description": "Master Promise creation, chaining, and error handling",
    "content": """
...
""",
    ...
    "difficulty": "intermediate",
    "order_index": 14,
    "tags": ["javascript", "promises", "async", "then", "catch"],
}

JS_NODE_15_ASYNC_AWAIT = {
    "id": "js-15-async-await",
...
# ============================================================================
# BLOCK 6: ADVANCED PATTERNS (Nodes 16-18)
# ============================================================================

JS_NODE_16_ERROR_HANDLING = {
    "id": "js-16-error-handling",
...
""",
    ...
    "difficulty": "intermediate",
    "order_index": 16,
    "tags": ["javascript", "errors", "try-catch", "debugging", "logging"],
}

JS_NODE_17_JSON_DATA = {
    "id": "js-17-json-data",
    "title": "JSON & Data Manipulation",
    "description": "Master JSON parsing, transformation, and data processing",
    "content": """
...
""",
    ...
    "difficulty": "intermediate",
    "order_index": 17,
    "tags": ["javascript", "json", "data", "transformation", "arrays"],
}

JS_NODE_18_FETCH_HTTP = {
    "id": "js-18-fetch-http",
    "title": "Fetch API & HTTP Requests",
    "description": "Master HTTP requests with Fetch, handle APIs, and build robust clients",
    "content": """
...
""",
    ...
    "difficulty": "intermediate",
    "order_index": 18,
    "tags": ["javascript", "fetch", "http", "api", "requests", "async"],
}


# ============================================================================
# BLOCK 7: NODE.JS & DEVOPS (Nodes 19-20)
# ============================================================================

JS_NODE_19_NODEJS_BASICS = {
    "id": "js-19-nodejs-basics",
    "title": "Node.js Fundamentals",
    "description": "Master Node.js runtime, file system, and process management",
    "content": """
...
""",
    ...
    "difficulty": "intermediate",
    "order_index": 19,
    "tags": ["javascript", "nodejs", "filesystem", "cli", "backend"],
}

JS_NODE_20_DEVOPS_CAPSTONE = {
    "id": "js-20-devops-capstone",
    "title": "JavaScript DevOps Capstone",
    "description": "Build a complete DevOps automation tool combining all concepts",
    "content": """
...
""",
    ...
    "difficulty": "advanced",
    "order_index": 20,
    "tags": ["javascript", "nodejs", "devops", "project", "capstone", "automation"],
}


# ============================================================================
# SKILLSMAP DEFINITION (Complete - All 7 Blocks)
# ============================================================================

def get_javascript_skillsmap() -> dict[str, Any]:
    """Return the complete JavaScript SkillsMap definition."""
    return {
        "id": "javascript",
        "name": "JavaScript for DevOps",
        "slug": "javascript",
        "description": "Master JavaScript from fundamentals to production patterns",
        "icon": "javascript",
        "color": "#F7DF1E",  # JavaScript yellow
        "estimated_hours": 25,
        "difficulty": "intermediate",
        "prerequisites": [],
        "tags": ["javascript", "nodejs", "programming", "web", "devops"],
        "nodes": [
            # Block 1: Noder 1-3
            JS_NODE_01_INTRODUCTION,
            JS_NODE_02_VARIABLES,
...
# Export for seeding
JAVASCRIPT_SKILLSMAP = get_javascript_skillsmap()
